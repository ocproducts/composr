...
class Module_vforums
{
    ...
    public function _vforum($title, $condition, $order, $separate_pins = true, $extra_tpl_map = array(), $initial_table = null, $extra_select = '')
    {
        ...
        if ($title->evaluate() == do_lang('TOPICS_UNREAD')) {
            ...
            $_buttons->attach(do_template('BUTTON_SCREEN', array('_GUID' => 'b96e17e77be6de6faf9eb340d7ba955a', 'TITLE' => do_lang_tempcode('ROOT_FORUM'), 'IMG' => 'buttons/mark_read_forum', 'IMMEDIATE' => false, 'URL' => $mark_read_url)));
        }
