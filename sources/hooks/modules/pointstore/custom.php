...
class Hook_pointstore_custom
{
    ...
    public function action_done()
    {
        ...
        dispatch_notification('pointstore_request_custom', 'custom' . strval($id) . '_' . strval($sale_id), $subject, $message_raw, null, null, array('create_ticket' => true, 'use_real_from' => true));
