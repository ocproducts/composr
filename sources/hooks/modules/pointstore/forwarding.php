...
class Hook_pointstore_forwarding
{
    ...
    public function __newforwarding()
    {
        ...
        dispatch_notification('pointstore_request_forwarding', 'forw_' . strval($sale_id), do_lang('MAIL_REQUEST_FORWARDING', null, null, null, get_site_default_lang()), $message_raw->evaluate(get_site_default_lang()), null, null, array('store_in_staff_messaging_system' => true, 'use_real_from' => true));
