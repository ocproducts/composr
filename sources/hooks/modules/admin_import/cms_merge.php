...
class Hook_cms_merge
{
    ...
    {
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_transactions') ? 'ecom_transactions' : 'transactions'), null, null, true);
        if (is_null($rows)) {
            return;
        }
        $this->_fix_comcode_ownership($rows);
        ...
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_invoices') ? 'ecom_invoices' : 'invoices') . ' ORDER BY id');
        $this->_fix_comcode_ownership($rows);
        $on_same_msn = ($this->on_same_msn($file_base));
        foreach ($rows as $row) {
        ...
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_subscriptions') ? 'ecom_subscriptions' : 'subscriptions') . ' ORDER BY id');
        $this->_fix_comcode_ownership($rows);
        foreach ($rows as $row) {
        ...
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_prods_prices') ? 'ecom_prods_prices' : 'prices'), null, null, true);
        if (is_null($rows)) {
            return;
        }
        $this->_fix_comcode_ownership($rows);
        ...
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_sales') ? 'ecom_sales' : 'sales'), null, null, true);
        if ($rows !== null) {
            $this->_fix_comcode_ownership($rows);
            $on_same_msn = ($this->on_same_msn($file_base));
            foreach ($rows as $row) {
    ...
    {
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_prods_custom') ? 'ecom_prods_custom' : 'pstore_customs'), null, null, true);
        if (is_null($rows)) {
            return;
        }
        $this->_fix_comcode_ownership($rows);
    ...
    {
        $rows = $db->query('SELECT * FROM ' . $table_prefix . ($db->table_exists('ecom_prods_permissions') ? 'ecom_prods_permissions' : 'pstore_permissions'), null, null, true);
        if (is_null($rows)) {
            return;
        }
        $this->_fix_comcode_ownership($rows);
