            ...
            foreach ($child_links as $child_link) {
                ...
                if (strpos($page_type, 'comcode') !== false) {
                    ...
                    if (preg_match('#^([^:]*):([^:]*)(:browse|:\w+=|$)#', $child_page_link, $matches) != 0) {
                        ...
                        $child_node = $page_sitemap_ob->get_node($child_page_link, $callback, $valid_node_types, $child_cutoff, $max_recurse_depth, $recurse_level + 1, $options | SITEMAP_GEN_USE_PAGE_GROUPINGS_SUPPRESS/*groupings already factored in, we don't want to get skipped*/, $zone, $meta_gather, $child_row);
                    } else {
