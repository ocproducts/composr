...
class Hook_resource_meta_aware_cpf
{
    ...
    public function info($zone = null)
    {
        return array(
            ...
            'add_url' => (function_exists('get_member') && has_actual_page_access(get_member(), 'admin_cns_customprofilefields')) ? (get_module_zone('admin_cns_customprofilefields') . ':admin_cns_customprofilefields:add') : null,
            'archive_url' => null,
