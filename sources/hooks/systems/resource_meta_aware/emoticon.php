...
class Hook_resource_meta_aware_emoticon
{
    ...
    public function info($zone = null, $get_extended_data = false)
    {
        return array(
            ...
            'add_url' => ($get_extended_data && function_exists('get_member') && has_actual_page_access(get_member(), 'admin_cns_emoticons')) ? (get_module_zone('admin_cns_emoticons') . ':admin_cns_emoticons:add') : null,
            'archive_url' => null,
