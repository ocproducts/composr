...
class Hook_resource_meta_aware_forum_grouping
{
    ...
    public function info($zone = null)
    {
        return array(
            ...
            'add_url' => (function_exists('get_member') && has_actual_page_access(get_member(), 'admin_cns_forum_groupings')) ? (get_module_zone('admin_cns_forum_groupings') . ':admin_cns_forum_groupings:add') : null,
            'archive_url' => null,
