...
class Hook_resource_meta_aware_post_template
{
    ...
    public function info($zone = null, $get_extended_data = false)
    {
        return array(
            ...
            'add_url' => ($get_extended_data && function_exists('get_member') && has_actual_page_access(get_member(), 'admin_cns_post_templates')) ? (get_module_zone('admin_cns_post_templates') . ':admin_cns_post_templates:add') : null,
            'archive_url' => null,
            ...
            'cms_page' => 'admin_cns_post_templates',
            'module' => null,
