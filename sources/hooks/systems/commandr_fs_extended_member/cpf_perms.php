 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_member__cpf_perms
{
    /**
    ...
    {
        return table_from_portable_rows('f_member_cpf_perms', $data, array('member_id' => $member_id), TABLE_REPLACE_MODE_BY_EXTRA_FIELD_DATA);
    }
}
