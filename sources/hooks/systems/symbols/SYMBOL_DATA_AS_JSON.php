...
class Hook_symbol_SYMBOL_DATA_AS_JSON
{
    ...
    public function run($param)
    {
        ...
        $value = array(
            ...
            'LANG'                   => ecv_LANG($lang, [], []),
            'BROWSER_UA'             => ecv_BROWSER_UA($lang, [], []),
            'OS'                     => ecv_OS($lang, [], []),
            'DEV_MODE'               => ecv_DEV_MODE($lang, [], []),
            'USER_AGENT'             => ecv_USER_AGENT($lang, [], []),
            'IP_ADDRESS'             => ecv_IP_ADDRESS($lang, [], []),
            'TIMEZONE'               => ecv_TIMEZONE($lang, [], []),
            'HTTP_STATUS_CODE'       => ecv_HTTP_STATUS_CODE($lang, [], []),
            'CHARSET'                => ecv_CHARSET($lang, [], []),
            'KEEP'                   => ecv_KEEP($lang, [], []),
            'FORCE_PREVIEWS'         => ecv_FORCE_PREVIEWS($lang, [], []),
            'PREVIEW_URL'            => ecv_PREVIEW_URL($lang, [], []),
            'SITE_NAME'              => ecv_SITE_NAME($lang, [], []),
            'COPYRIGHT'              => ecv_COPYRIGHT($lang, [], []),
            'DOMAIN'                 => ecv_DOMAIN($lang, [], []),
            'FORUM_BASE_URL'         => ecv_FORUM_BASE_URL($lang, [], []),
            'BASE_URL'               => ecv_BASE_URL($lang, [], []),
            'CUSTOM_BASE_URL'        => ecv_CUSTOM_BASE_URL($lang, [], []),
            'BASE_URL_NOHTTP'        => ecv_BASE_URL_NOHTTP($lang, [], []),
            'CUSTOM_BASE_URL_NOHTTP' => ecv_CUSTOM_BASE_URL_NOHTTP($lang, [], []),
            'BRAND_NAME'             => ecv_BRAND_NAME($lang, [], []),
            'IS_STAFF'               => ecv_IS_STAFF($lang, [], []),
            'IS_ADMIN'               => ecv_IS_ADMIN($lang, [], []),
            'VERSION'                => ecv_VERSION($lang, [], []),
            'COOKIE_PATH'            => ecv_COOKIE_PATH($lang, [], []),
            'COOKIE_DOMAIN'          => ecv_COOKIE_DOMAIN($lang, [], []),
            'IS_HTTPAUTH_LOGIN'      => ecv_IS_HTTPAUTH_LOGIN($lang, [], []),
            'IS_A_COOKIE_LOGIN'      => ecv_IS_A_COOKIE_LOGIN($lang, [], []),
            'SESSION_COOKIE_NAME'    => ecv_SESSION_COOKIE_NAME($lang, [], []),
            'GROUP_ID'               => ecv_GROUP_ID($lang, [], []),
