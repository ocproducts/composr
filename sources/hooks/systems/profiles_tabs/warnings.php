...
class Hook_profiles_tabs_warnings
{
    ...
    public function render_tab($member_id_of, $member_id_viewing, $leave_to_ajax_if_possible = false)
    {
        ...
        foreach ($rows as $row) {
            ...
            $explanation = hyperlink(build_url(array('page' => 'warnings', 'type' => '_edit', 'id' => $row['id'], 'redirect' => static_evaluate_tempcode($GLOBALS['FORUM_DRIVER']->member_profile_url($member_id_of, true))), get_module_zone('warnings')), $row['w_explanation'], false, true, $row['w_explanation_orig']);
