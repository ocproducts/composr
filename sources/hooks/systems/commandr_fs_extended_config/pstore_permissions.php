...
class Hook_commandr_fs_extended_config__pstore_permissions
{
    ...
    {
        $query = 'SELECT MAX(date_and_time) FROM ' . get_table_prefix() . 'adminlogs WHERE ' . db_string_equal_to('the_type', 'POINTSTORE_AMEND_CUSTOM_PERMISSIONS');
    ...
    {
        return table_from_json('pstore_permissions', $contents, array('id'), TABLE_REPLACE_MODE_SEVERE);
    }
}
