 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__pstore_customs
{
    /**
    ...
    {
        return table_to_json('pstore_customs');
    }
    ...
    {
        return table_from_json('pstore_customs', $contents, array('id'), TABLE_REPLACE_MODE_SEVERE);
    }
}
