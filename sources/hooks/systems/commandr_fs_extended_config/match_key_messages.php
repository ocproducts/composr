...
class Hook_commandr_fs_extended_config__match_key_messages
{
    ...
    {
        $query = 'SELECT MAX(date_and_time) FROM ' . get_table_prefix() . 'actionlogs WHERE ' . db_string_equal_to('the_type', 'PAGE_MATCH_KEY_ACCESS');
    ...
    {
        return table_from_json('match_key_messages', $contents, array('id'), TABLE_REPLACE_MODE_SEVERE);
    }
}
