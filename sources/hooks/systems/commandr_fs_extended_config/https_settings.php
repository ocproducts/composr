 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__https_settings
{
    /**
    ...
    {
        return table_from_json('https_pages', $contents, array(), TABLE_REPLACE_MODE_SEVERE);
    }
}
