 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__ecom_prods_custom
{
    /**
    ...
    {
        $query = 'SELECT MAX(date_and_time) FROM ' . get_table_prefix() . 'actionlogs WHERE ' . db_string_equal_to('the_type', 'ECOM_PRODUCTS_AMEND_CUSTOM_PRODUCTS');
    ...
    {
        return table_to_json('ecom_prods_custom');
    }
    ...
    {
        return table_from_json('ecom_prods_custom', $contents, array(), TABLE_REPLACE_MODE_SEVERE);
    }
}
