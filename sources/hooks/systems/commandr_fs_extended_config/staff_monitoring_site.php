 ...
 * Hook class.
 */
class Hook_commandr_fs_extended_config__staff_monitoring_site
{
    /**
    ...
    {
        $query = 'SELECT MAX(date_and_time) FROM ' . get_table_prefix() . 'adminlogs WHERE ' . db_string_equal_to('the_type', 'SITE_WATCHLIST');
    ...
    {
        return table_from_json('sitewatchlist', $contents, null, TABLE_REPLACE_MODE_SEVERE);
    }
}
