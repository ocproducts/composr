...
class Hook_content_meta_aware_banner
{
    ...
    public function info($zone = null, $get_extended_data = false)
    {
        return array(
            ...
            'add_url' => ($get_extended_data && function_exists('has_submit_permission') && has_submit_permission('mid', get_member(), get_ip_address(), 'cms_banners')) ? (get_module_zone('cms_banners') . ':cms_banners:add') : null,
            'archive_url' => null,
