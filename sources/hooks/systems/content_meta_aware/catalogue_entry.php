...
class Hook_content_meta_aware_catalogue_entry
{
    ...
    public function info($zone = null, $get_extended_data = false, $catalogue_name = null)
    {
        return array(
            ...
            'add_url' => ($get_extended_data && function_exists('has_submit_permission') && has_submit_permission('mid', get_member(), get_ip_address(), 'cms_catalogues')) ? (get_module_zone('cms_catalogues') . ':cms_catalogues:add_entry' . (is_null($catalogue_name) ? '' : (':catalogue_name=' . $catalogue_name))) : null,
            'archive_url' => $get_extended_data ? (((!is_null($zone)) ? $zone : get_module_zone('catalogues')) . ':catalogues') : null,
