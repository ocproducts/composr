...
class Hook_page_groupings_core
{
    ...
    public function run($member_id = null, $extensive_docs = false)
    {
        ...
        return array(
            ...
            (get_forum_type() != 'cns') ? null : array('style', 'menu/adminzone/style/emoticons', array('admin_cns_emoticons', array('type' => 'browse'), get_module_zone('admin_cns_emoticons')), do_lang_tempcode('ITEMS_HERE', do_lang_tempcode('EMOTICONS'), make_string_tempcode(escape_html(integer_format($GLOBALS['FORUM_DB']->query_select_value('f_emoticons', 'COUNT(*)', array(), '', true))))), 'cns:DOC_EMOTICONS'),
