...
class Hook_page_groupings_core
{
    ...
    public function run($member_id = null, $extensive_docs = false)
    {
        ...
        return array(
            ...
            array('setup', 'menu/adminzone/setup/config/config', array('admin_oauth', array('type' => 'browse'), get_module_zone('admin_oauth')), do_lang_tempcode('oauth:_OAUTH_TITLE'), 'oauth:DOC_OAUTH'), // TODO: new icon #2966
            ...
            array('tools', 'menu/adminzone/tools/cleanup', array('admin_broken_urls', array('type' => 'browse'), get_module_zone('admin_broken_urls')), do_lang_tempcode('cleanup:BROKEN_URLS'), 'cleanup:DOC_BROKEN_URLS'), // TODO: new icon #2966
