...
class Hook_page_groupings_core
{
    ...
    public function run($member_id = null, $extensive_docs = false)
    {
        ...
        return array(
            array('', 'menu/adminzone/' . DEFAULT_ZONE_PAGE_NAME, array(DEFAULT_ZONE_PAGE_NAME, array(), 'adminzone'), do_lang_tempcode('menus:DASHBOARD'), $extensive_docs ? 'menus:DOC_DASHBOARD' : 'menus:MM_TOOLTIP_DASHBOARD'),
            ...
            (_request_page('website', 'adminzone') === null) ? array('', 'help', get_brand_base_url() . '/docs' . strval(cms_version()) . '/', do_lang_tempcode('menus:DOCS'), $extensive_docs ? 'menus:DOCS' : 'menus:MM_TOOLTIP_DOCS') : null,
            (_request_page('website', 'adminzone') === null) ? null : array('', 'help', array('website', array(), 'adminzone'), do_lang_tempcode('menus:DOCS'), $extensive_docs ? 'menus:DOCS' : 'menus:MM_TOOLTIP_DOCS'),
            ...
            (get_value('hide_zone_editor') === '1') ? null : array('structure', 'menu/adminzone/structure/zones/zone_editor', array('admin_zones', array('type' => 'editor'), get_module_zone('admin_zones')), do_lang_tempcode('zones:ZONE_EDITOR'), 'zones:DOC_ZONE_EDITOR'),
            ...
            addon_installed('page_management') ? array('structure', 'menu/adminzone/structure/sitemap/sitemap_editor', array('admin_sitemap', array('type' => 'browse'), get_module_zone('admin_sitemap')), do_lang_tempcode('zones:SITEMAP_EDITOR'), 'zones:DOC_SITEMAP_EDITOR') : null,
            ...
            addon_installed('robots_txt') ? array('structure', 'spare/seo', array('admin_robots_txt', array(), get_module_zone('admin_robots_txt')), do_lang_tempcode('robots_txt:ROBOTS_TXT'), 'robots_txt:DOC_ROBOTS_TXT') : null,
            ...
            addon_installed('errorlog') ? array('audit', 'menu/adminzone/audit/errorlog', array('admin_errorlog', array(), get_module_zone('admin_errorlog')), do_lang_tempcode('errorlog:ERRORLOG'), 'errorlog:DOC_ERRORLOG') : null,
            ...
            (!addon_installed('actionlog') || get_option('store_revisions') == '0') ? null : array('audit', 'admin/revisions', array('admin_revisions', array('type' => 'browse'), get_module_zone('admin_revisions')), do_lang_tempcode('actionlog:REVISIONS'), 'actionlog:DOC_REVISIONS'),
            ...
            array('setup', 'menu/adminzone/setup/oauth', array('admin_oauth', array('type' => 'browse'), get_module_zone('admin_oauth')), do_lang_tempcode('oauth:_OAUTH_TITLE'), 'oauth:DOC_OAUTH'),
            ...
            array('tools', 'menu/adminzone/tools/broken_urls', array('admin_broken_urls', array('type' => 'browse'), get_module_zone('admin_broken_urls')), do_lang_tempcode('cleanup:BROKEN_URLS'), 'cleanup:DOC_BROKEN_URLS'),
            (get_value('brand_base_url') === null) ? array('tools', 'menu/adminzone/tools/upgrade', array('admin_config', array('type' => 'upgrader'), get_module_zone('admin_config')), do_lang_tempcode('upgrade:UPGRADER_UPGRADER_TITLE'), 'upgrade:UPGRADER_UPGRADER_INTRO') : null,
            ((addon_installed('syndication')) && (get_value('hide_rss') === '0')) ? array('tools', 'links/rss', array('admin_config', array('type' => 'backend'), get_module_zone('admin_config')), do_lang_tempcode('FEEDS'), 'rss:OPML_INDEX_DESCRIPTION') : null,
            ...
            (get_forum_type() != 'cns') ? null : array('security', 'menu/social/members', array('admin_cns_members', array(), get_module_zone('admin_cns_members')), do_lang_tempcode('MEMBERS'), 'cns:DOC_MEMBERS'),
