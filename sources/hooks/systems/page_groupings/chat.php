...
class Hook_page_groupings_chat
{
    ...
    public function run($member_id = null, $extensive_docs = false)
    {
        ...
        return array(
            array('cms', 'menu/social/chat/chat', array('cms_chat', array('type' => 'browse'), get_module_zone('cms_chat')), do_lang_tempcode('ITEMS_HERE', do_lang_tempcode('chat:CHAT_MODERATION'), make_string_tempcode(escape_html(integer_format(@intval($GLOBALS['SITE_DB']->query_select_value('chat_rooms', 'COUNT(*)', array(), '', true)))))), 'chat:DOC_CHAT'),
