...
class Hook_page_groupings_quiz
{
    ...
    public function run($member_id = null, $extensive_docs = false)
    {
        ...
        return array(
            ...
            array('cms', 'menu/rich_content/quiz', array('cms_quiz', array('type' => 'browse'), get_module_zone('cms_quiz')), do_lang_tempcode('ITEMS_HERE', do_lang_tempcode('quiz:QUIZZES'), make_string_tempcode(escape_html(integer_format(@intval($GLOBALS['SITE_DB']->query_select_value('quizzes', 'COUNT(*)', array(), '', true)))))), 'quiz:DOC_QUIZZES'),
