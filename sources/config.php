    ...
    if ($default === null) {
        switch ($name) {
            ...
            case 'themewizard_images':
                $default = 'outer_background,inner_background,block_background,1x/treefield/category,cns_emoticons/none,1x/edited,icons/28x28/action_link,icons/32x32/help,background_image,icons/28x28/helper_panel_hide,icons/28x28/helper_panel_show,checklist/checklist0,checklist/checklist1,checklist/checklist-,1x/menus/menu_bullet,1x/menus/menu_bullet_hover,1x/menus/menu_bullet_current,1x/arrow_box,1x/arrow_box_hover,1x/boxless_title_leadin_leftcomp,1x/boxless_title_leadin_rightcomp,1x/breadcrumbs,icons/48x48/tool_buttons/top,1x/trays/expand,1x/trays/contract,1x/trays/expand2,1x/trays/contract2,comcodeeditor/*,permlevels/*,cns_general/new_posts,cns_general/no_new_posts,cns_general/redirect,icons/28x28/cns_topic_modifiers/unread,icons/28x28/cns_topic_modifiers/involved,logo/standalone_logo,logo/-logo,logo/default_logos/logo1,logo/default_logos/logo2,logo/default_logos/logo4,logo/default_logos/logo5,logo/default_logos/logo7,logo/default_backgrounds/banner1,logo/default_backgrounds/banner3C,logo/default_backgrounds/banner8A,gradient,quote_gradient,button1,button2,carousel/button_left_hover,carousel/button_right_hover,big_tabs_controller_button_active,big_tabs_controller_button_top_active,big_tabs_controller_button_top,big_tabs_controller_button,poll/*,1x/box_arrow,tab,mediaset_next,mediaset_previous';
                break;
