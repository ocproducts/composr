    ...
    if ($default === null) {
        switch ($name) {
            ...
            case 'themewizard_images':
                $default = 'outer_background,inner_background,block_background,icons/tree_field/category,cns_emoticons/none,edited,icons/help,background_image,icons/helper_panel/hide,icons/helper_panel/show,icons/checklist/checklist_todo,icons/checklist/checklist_done,icons/checklist/checklist_na,icons/menus/menu_bullet,icons/menus/menu_bullet_hover,icons/menus/menu_bullet_current,icons/arrow_box/arrow_box,icons/arrow_box/arrow_box_hover,boxes/boxless_title_leadin_leftcomp,boxes/boxless_title_leadin_rightcomp,icons/breadcrumbs,icons/tool_buttons/top,icons/trays/expand,icons/trays/contract,icons/trays/expand2,icons/trays/contract2,comcode_editor/*,perm_levels/*,icons/cns_general/new_posts,icons/cns_general/no_new_posts,icons/cns_general/redirect,icons/cns_topic_modifiers/unread,icons/cns_topic_modifiers/involved,logo/standalone_logo,logo/-logo,logo/default_logos/logo1,logo/default_logos/logo2,logo/default_logos/logo4,logo/default_logos/logo5,logo/default_logos/logo7,logo/default_backgrounds/banner1,logo/default_backgrounds/banner3C,logo/default_backgrounds/banner8A,gradient,quote_gradient,button1,button2,carousel/button_left_hover,carousel/button_right_hover,big_tabs/controller_button_active,big_tabs/controller_button_top_active,big_tabs/controller_button_top,big_tabs/controller_button,poll/*,boxes/arrow,tab,icons/media_set/next,icons/media_set/previous';
                break;
