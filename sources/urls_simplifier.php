...
class HarmlessURLCoder
{
    ...
    public function __construct()
    {
        foreach (array(
            ...
            chr(11),
            chr(12),
            '%', // Used for encoding itself
            '/', // Separating path components
            '?', // Query string specifier
            ':', // Port specifier / Password specifier
            '&', // Separating GET parameters
            '=', // Separating key and value for GET parameters
            '@', // Login specifier
            '+', // Space symbol for urlencode syntax (not used for rawurlencode syntax)
    ...
    public function decode($str)
    {
        ...
        if ((!function_exists('get_option')) || (get_option('urls_simplifier') == '0')) {
            return $str;
        }
