...
function init__database_relations()
{
    ...
    define('TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE', 4); // Flushable if we're being extra aggressive
    define('TABLE_PURPOSE__NO_STAGING_COPY', 8); // For some special reason we don't copy this between staging to live
...
function get_table_purpose_flags()
{
    return array(
        ...
        'alternative_ids' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE | TABLE_PURPOSE__SUBDATA/*under <content>*/,
        'attachment_refs' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under attachments*/,
        'attachments' => TABLE_PURPOSE__NORMAL,
        'authors' => TABLE_PURPOSE__NORMAL,
        'autosave' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE,
        'award_archive' => TABLE_PURPOSE__NORMAL,
        'award_types' => TABLE_PURPOSE__NORMAL,
        'banned_ip' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE,
        ...
        'calendar_jobs' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE | TABLE_PURPOSE__SUBDATA/*under calendar_events*/,
        ...
        'customtasks' => TABLE_PURPOSE__NORMAL,
        ...
        'digestives_consumed' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE,
        'digestives_tin' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE,
        ...
        'f_invites' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE,
        ...
        'f_member_known_login_ips' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE | TABLE_PURPOSE__SUBDATA/*under f_members*/,
        ...
        'f_warnings' => TABLE_PURPOSE__NORMAL,
        'f_welcome_emails' => TABLE_PURPOSE__NORMAL,
        'failedlogins' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE,
        'feature_lifetime_monitor' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE,
        'filedump' => TABLE_PURPOSE__NORMAL,
        ...
        'group_page_access' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under f_groups*/,
        'group_privileges' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under f_groups*/,
        ...
        'https_pages' => TABLE_PURPOSE__NORMAL,
        ...
        'match_key_messages' => TABLE_PURPOSE__NORMAL,
        'member_category_access' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under <content>*/,
        'member_page_access' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under f_members*/,
        'member_privileges' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under f_members*/,
        ...
        'newsletter_archive' => TABLE_PURPOSE__NORMAL,
        ...
        'notification_lockdown' => TABLE_PURPOSE__NORMAL,
        ...
        'prices' => TABLE_PURPOSE__NORMAL,
        'privilege_list' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__AUTOGEN_STATIC,
        'pstore_customs' => TABLE_PURPOSE__NORMAL,
        'pstore_permissions' => TABLE_PURPOSE__NORMAL,
        'quiz_entries' => TABLE_PURPOSE__NORMAL,
        ...
        'redirects' => TABLE_PURPOSE__NORMAL,
        ...
        'shopping_cart' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE | TABLE_PURPOSE__MISC_NO_MERGE,
        'shopping_logging' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE,
        'shopping_order' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE | TABLE_PURPOSE__MISC_NO_MERGE,
        'shopping_order_addresses' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE | TABLE_PURPOSE__MISC_NO_MERGE | TABLE_PURPOSE__SUBDATA/*under shopping_order*/,
        'shopping_order_details' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE | TABLE_PURPOSE__MISC_NO_MERGE | TABLE_PURPOSE__SUBDATA/*under shopping_order*/,
        'sitemap_cache' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__NO_BACKUPS | TABLE_PURPOSE__FLUSHABLE,
        'sitewatchlist' => TABLE_PURPOSE__NORMAL,
        ...
        'stafflinks' => TABLE_PURPOSE__NORMAL,
        ...
        'task_queue' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE,
        'temp_block_permissions' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__NO_BACKUPS | TABLE_PURPOSE__FLUSHABLE,
        'theme_images' => TABLE_PURPOSE__NORMAL,
        ...
        'trans_expecting' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE | TABLE_PURPOSE__MISC_NO_MERGE,
        ...
        'url_id_monikers' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE | TABLE_PURPOSE__SUBDATA/*under <content>*/,
        ...
        'values' => TABLE_PURPOSE__NORMAL,
        'values_elective' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE,
        'video_transcoding' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__MISC_NO_MERGE,
        ...
        'wiki_children' => TABLE_PURPOSE__NORMAL,
        'wiki_pages' => TABLE_PURPOSE__NORMAL,
        'wiki_posts' => TABLE_PURPOSE__NORMAL,
        'wordfilter' => TABLE_PURPOSE__NORMAL,
