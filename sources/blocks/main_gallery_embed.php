        ...
        $info['cache_on'] = <<<'PHP'
            (preg_match('#<\w+>#', (array_key_exists('filter', $map) ? $map['filter'] : '') . (array_key_exists('video_filter', $map) ? $map['video_filter'] : '')) != 0) 
                ? null : array(
                    ...
                    array_key_exists('filter', $map) ? $map['filter'] : '', array_key_exists('video_filter', $map) ? $map['video_filter'] : '', 
                    array_key_exists('render_if_empty', $map) ? $map['render_if_empty'] : '0', array_key_exists('days', $map) ? $map['days'] : '', 
