...
function request_via_cron($codename, $map, $special_cache_flags, $tempcode)
{
    ...
    $theme = null;
    $lang = null;
    get_cache_signature_details($special_cache_flags, $staff_status, $member, $groups, $is_bot, $timezone, $theme, $lang);
 ...
 */
function set_cache_entry($codename, $ttl, $cache_identifier, $cache, $special_cache_flags = CACHE_AGAINST_DEFAULT, $_langs_required = array(), $_javascripts_required = array(), $_csss_required = array(), $tempcode = false, $staff_status = null, $member = null, $groups = null, $is_bot = null, $timezone = null, $theme = null, $lang = null)
{
    get_cache_signature_details($special_cache_flags, $staff_status, $member, $groups, $is_bot, $timezone, $theme, $lang);
