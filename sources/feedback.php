...
function update_spacer_post($allow_comments, $content_type, $content_id, $content_url, $content_title, $forum = null, $post_id = null)
{
    ...
    if (get_forum_type() == 'cns') {
        ...
        require_code('cns_topics_action2');
        cns_edit_topic($topic_id, do_lang('COMMENT', null, null, null, get_site_default_lang()) . ': #' . $content_type . '_' . $content_id, null, null, null, null, null, null, '', null, $home_link->evaluate(), false);
    }
}
