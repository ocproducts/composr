...
$feature_tree = array(
    ...
    'browse' => array(
        ...
        'banners' => array(
            'Banners <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Banners" href="http://shareddemo.composr.info/cms/index.php?page=cms_banners"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'search' => array(
            'Search engine <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Search engine" href="http://shareddemo.composr.info/site/index.php?page=search"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'newsletters' => array(
            'Newsletters <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Newsletters" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_newsletter"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'featured' => array(
            'Featured content <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Featured content" href="http://shareddemo.composr.info/lorem/index.php?page=start"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'ecommerce' => array(
            'eCommerce and subscriptions <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of eCommerce" href="http://shareddemo.composr.info/site/index.php?page=catalogues&amp;type=index&amp;id=products"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'support' => array(
            'Support tickets <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of ticket system" href="http://shareddemo.composr.info/site/index.php?page=tickets"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'web20' => array(
        'polls' => array(
            'Polls <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Polls" href="http://shareddemo.composr.info/site/index.php?page=polls&amp;type=view&amp;id=1"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'points' => array(
            ...
            array(
                ...
                array('Point store', 'Members can buy advertising space, temporary privileges, gamble, and more! <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Point Store" href="http://shareddemo.composr.info/site/index.php?page=pointstore"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'community' => array(
            'Community features',
            array(
                array('User content submission', 'Allow users to submit to any area of your site. Staff approval is supported <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of CMS" href="http://shareddemo.composr.info/cms/index.php?page=cms"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Public awards', 'Give public awards to your choice of &ldquo;best content&rdquo; <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Awards" href="http://shareddemo.composr.info/site/index.php?page=awards"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Bookmarks', 'Users can bookmark their favourite pages to their account <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Bookmarks" href="http://shareddemo.composr.info/site/index.php?page=bookmarks"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'chat' => array(
            'Chatrooms and instant messaging <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Chatrooms" href="http://shareddemo.composr.info/site/index.php?page=chat"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'content' => array(
        'catalogues' => array(
            'Catalogues <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Catalogues" href="http://shareddemo.composr.info/site/index.php?page=catalogues"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'wiki' => array(
            'Wiki+ <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Wiki+" href="http://shareddemo.composr.info/site/index.php?page=wiki"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'news' => array(
            'News and blogging <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of News" href="http://shareddemo.composr.info/site/index.php?page=news"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'galleries' => array(
            'Galleries <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Galleries" href="http://shareddemo.composr.info/site/index.php?page=galleries"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'downloads' => array(
            'Downloads/documents library <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Downloads" href="http://shareddemo.composr.info/site/index.php?page=downloads"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'pages' => array(
            'Web pages <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Page support" href="http://shareddemo.composr.info/lorem/index.php?page=lorem"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'architecture' => array(
        'debranding' => array(
            'Debranding <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Debranding" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_debrand"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(),
            'Use Composr for clients and pretend <strong>you</strong> made it',
        ),
        'permissions' => array(
            'Permissions <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Permissions" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_permissions"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'extendable' => array(
            ...
            array(
                array('Versatile', 'You can strip down to a core system, or build up with 3rd-party addons <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Addons" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_addons"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
    ...
    'design' => array(
        'adminzone' => array(
            'Administration Zone',
            array(
                array('Status overview', 'Upgrade and task notification from the Admin Zone front page <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Admin Zone" href="http://shareddemo.composr.info/adminzone/index.php?page=start"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Backups', 'Create and schedule full and incremental backups, local or remote <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Backups" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_backup"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Analytics', 'Website statistics rendered as charts <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Statistics" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_stats"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                array('Conflict detection', 'Detect when two staff are trying to change the same thing at the same time'),
                array('Examine audit trails', 'See exactly who has done what and when <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Audit Trails" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_actionlog"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Detect broken URLs <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Cleanup Tools" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_cleanup"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'richmedia' => array(
            'Rich media <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Comcode" href="http://shareddemo.composr.info/lorem/index.php?page=lorem"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'standards' => array(
        'security' => array(
            ...
            array(
                ...
                array('Automatic detection and banning of hackers <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of IP Banning" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_ip_ban"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Track failed logins <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Security" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_security"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'spam' => array(
            ...
            array(
                array('Configurable swear filtering <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Word Filter" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_wordfilter"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
    ...
    'forums' => array(
        'cnsmembers' => array(
            'Membership',
            array(
                array('Profiles', 'Browse through and search for members, and view member profiles <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Member Directory" href="http://shareddemo.composr.info/site/index.php?page=members"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Allow members to create and manage a club <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Clubs" href="http://shareddemo.composr.info/cms/index.php?page=cms_cns_groups"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'cnsforum' => array(
            'Forums',
            array(
                array('The usual stuff', 'Categories, forums, topics, posts, polls <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Forum" href="http://shareddemo.composr.info/forum/index.php?page=forumview"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Inline personal posts', 'Whisper to members within a public topic <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Whispering" href="http://shareddemo.composr.info/forum/index.php?page=topicview&amp;type=browse&amp;id=2"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'tracking' => array(
            ...
            array(
                array('Find posts made since you last visited <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of New Posts" href="http://shareddemo.composr.info/forum/index.php?page=vforums"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
        ...
        'forumcontentsharing' => array(
            'Content sharing',
            array(
                array('Show topics on your website <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of displayed forum topics" href="http://shareddemo.composr.info/lorem/index.php?page=start"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
                null, // divider
