...
$feature_tree = array(
    ...
    'browse' => array(
        'installation' => array(
            'Installation <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Installation" href="{$PAGE_LINK*,docs:tut_install}"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'banners' => array(
            'Banners <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Banners" href="http://shareddemo.composr.info/cms/index.php?page=cms_banners"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'search' => array(
            'Search engine <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Search engine" href="http://shareddemo.composr.info/site/index.php?page=search"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'newsletters' => array(
            'Newsletters <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Newsletters" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_newsletter"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'featured' => array(
            'Featured content <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Featured content" href="http://shareddemo.composr.info/lorem/index.php?page=start"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'ecommerce' => array(
            'eCommerce and subscriptions <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of eCommerce" href="http://shareddemo.composr.info/site/index.php?page=catalogues&amp;type=index&amp;id=products"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'support' => array(
            'Support tickets <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of ticket system" href="http://shareddemo.composr.info/site/index.php?page=tickets"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'web20' => array(
        'polls' => array(
            'Polls <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Polls" href="http://shareddemo.composr.info/site/index.php?page=polls&amp;type=view&amp;id=1"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'community' => array(
            ...
            array(
                ...
                array('Public awards', 'Give public awards to your choice of &ldquo;best content&rdquo; <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Awards" href="http://shareddemo.composr.info/site/index.php?page=awards"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Bookmarks', 'Users can bookmark their favourite pages to their account <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Bookmarks" href="http://shareddemo.composr.info/site/index.php?page=bookmarks"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'chat' => array(
            'Chatrooms and instant messaging <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Chatrooms" href="http://shareddemo.composr.info/site/index.php?page=chat"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'content' => array(
        'catalogues' => array(
            'Catalogues <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Catalogues" href="http://shareddemo.composr.info/site/index.php?page=catalogues"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'wiki' => array(
            'Wiki+ <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Wiki+" href="http://shareddemo.composr.info/site/index.php?page=wiki"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'calendar' => array(
            'Calendar <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Calendar" href="http://shareddemo.composr.info/site/index.php?page=calendar"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'news' => array(
            'News and blogging <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of News" href="http://shareddemo.composr.info/site/index.php?page=news"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
                array('Member blogs', 'Allow members to have their own blogs <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of News" href="http://shareddemo.composr.info/cms/index.php?page=cms_blogs"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Import from RSS feeds <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of News" href="http://shareddemo.composr.info/cms/index.php?page=cms_news"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                (!is_maintained('ip_geocoding')) ? false : array('Geotargetting'),
            ),
        ),
        'quizzes' => array(
            'Quizzes <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Quizzes" href="http://shareddemo.composr.info/site/index.php?page=quiz"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'galleries' => array(
            'Galleries <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Galleries" href="http://shareddemo.composr.info/site/index.php?page=galleries"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'downloads' => array(
            'Downloads/documents library <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Downloads" href="http://shareddemo.composr.info/site/index.php?page=downloads"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'pages' => array(
            'Web pages <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Page support" href="http://shareddemo.composr.info/lorem/index.php?page=lorem"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'architecture' => array(
        'debranding' => array(
            'Debranding <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Debranding" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_debrand"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(),
            'Use Composr for clients and pretend <strong>you</strong> made it',
        ),
        'permissions' => array(
            'Permissions <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Permissions" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_permissions"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'extendable' => array(
            ...
            array(
                ...
                array('Full <abbr title="Application Programming Interface">API</abbr> documentation <a target="_blank" class="link-exempt no-print" title="(Opens in new window) API documentation" href="{$BRAND_BASE_URL}/docs/api/"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                array('High coding standards', 'No PHP notices. Type-strict codebase. We use <abbr title="Model View Controller">MVC</abbr>'),
                array('Free online developer\'s guide book <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Developers Documentation" href="{$PAGE_LINK*,docs:codebook}"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                null, // divider
        ...
        'integration' => array(
            ...
            array(
                ...
                (!is_maintained('ldap')) ? false : array('LDAP support for corporate networks (<abbr title="The Composr forum">Conversr</abbr>) <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Help of LDAP usage" href="{$PAGE_LINK*,docs:tut_ldap}"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                null, // divider
                ...
                array('Minimodules and miniblocks', 'Programmers can port existing PHP code into Composr itself <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Framework documentation" href="{$PAGE_LINK*,docs:tut_framework}"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
            ),
        ),
    ),
    'design' => array(
        'adminzone' => array(
            ...
            array(
                ...
                array('Analytics', 'Website statistics rendered as charts <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Statistics" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_stats"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Detect broken URLs <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Cleanup Tools" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_cleanup"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'tools' => array(
            ...
            array(
                ...
                array('Quick-start logo wizard <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Logo Wizard" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_themewizard&amp;type=make_logo"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'tempcode' => array(
            'Template programming language (Tempcode) <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Tempcode" href="{$PAGE_LINK*,docs:tut_tempcode}"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'rad' => array(
            ...
            array(
                array('Switch users', 'Masquerade as any user using your admin login <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of SU" href="http://shareddemo.composr.info/index.php?keep_su=test"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                array('Change theme images inline with just a few clicks'),
                array('Easily find and edit the templates used to construct any screen <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Template Tree" href="http://shareddemo.composr.info/index.php?special_page_type=tree"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'richmedia' => array(
            'Rich media <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Comcode" href="http://shareddemo.composr.info/lorem/index.php?page=lorem"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'standards' => array(
        'security' => array(
            ...
            array(
                ...
                array('Automatic detection and banning of hackers <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of IP Banning" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_ip_ban"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                ...
                array('Track failed logins <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Security" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_security"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'spam' => array(
            ...
            array(
                array('Configurable swear filtering <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Word Filter" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_wordfilter"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                array('IP address analysis', 'Audit, check, and ban <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Lookup Tools" href="http://shareddemo.composr.info/adminzone/index.php?page=admin_lookup"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'easeofuse' => array(
            'Ease of use <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Ease of use" href="{$BRAND_BASE_URL}/docs/"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'webstandards' => array(
            'Web standards <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Web standards" href="{$PAGE_LINK*,site:vision}"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'itln' => array(
            'Localisation support <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Localisation" href="https://www.transifex.com/organization/ocproducts/dashboard"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
        ...
        'seo' => array(
            '<abbr title="Search Engine Optimisation">SEO</abbr> <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of SEO" href="http://shareddemo.composr.info/index.php?page=sitemap"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>',
            array(
    ...
    'forums' => array(
        'cnsmembers' => array(
            ...
            array(
                ...
                array('Allow members to create and manage a club <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Clubs" href="http://shareddemo.composr.info/cms/index.php?page=cms_cns_groups"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                array('Over 40 bundled avatars', 'Member\'s may also upload or link to their own <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Avatars" href="http://shareddemo.composr.info/site/index.php?page=members&type=view#tab__edit__avatar"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                array('Member signatures, photos, and personal titles <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Personal Zone" href="http://shareddemo.composr.info/site/index.php?page=members&type=view#tab__edit"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'cnsforum' => array(
            'Forums',
            array(
                array('The usual stuff', 'Categories, forums, topics, posts, polls <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of Forum" href="http://shareddemo.composr.info/forum/index.php?page=forumview"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
        ...
        'tracking' => array(
            ...
            array(
                array('Find posts made since you last visited <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of New Posts" href="http://shareddemo.composr.info/forum/index.php?page=vforums"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                ...
                null, // divider
                array('<abbr title="Really Simple Syndication">RSS</abbr> and Atom support <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of RSS Feeds" href="http://shareddemo.composr.info/backend.php"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
            ),
            'Conversr-only',
        ),
        'forumdrivers' => array(
        ...
        'forumcontentsharing' => array(
            'Content sharing',
            array(
                array('Show topics on your website <a target="_blank" class="link-exempt no-print" title="(Opens in new window) Example of displayed forum topics" href="http://shareddemo.composr.info/lorem/index.php?page=start"><img class="inline-image-3" alt="" width="12" height="12" src="{$IMG*,help_small}" /></a>'),
                null, // divider
