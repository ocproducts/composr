...
$feature_tree = array(
    ...
    'design' => array(
        'adminzone' => array(
            'Administration Zone',
            array(
                array('Status overview', 'Upgrade and task notification from the Admin Zone dashboard <a target="_blank" class="link_exempt no_print" title="(Opens in new window) Example of Admin Zone" href="http://shareddemo.composr.info/adminzone/index.php?page=start"><img class="inline_image_3" alt="" src="{$IMG*,help_small}" /></a>'),
