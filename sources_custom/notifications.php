...
if (!function_exists('init__notifications')) {
    ...
    {
        $before = '$dispatcher = ';
        $after = 'if ($notification_code == \'cns_topic\' && is_numeric($code_category) && ($GLOBALS[\'FORUM_DB\']->query_select_value_if_there(\'f_topics\', \'t_forum_id\', array(\'id\' => intval($code_category))) === null) || $notification_code == \'cns_new_pt\' || $notification_code == \'ticket_new_staff\' || $notification_code == \'ticket_reply\' || $notification_code == \'ticket_reply_staff\') { require_code(\'password_censor\'); $message = _password_censor($message, PASSWORD_CENSOR__INTERACTIVE_SCAN); } $dispatcher = ';
