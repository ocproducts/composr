...
class Hook_page_groupings_static_export
{
    ...
    {
        return array(
            array('tools', 'admin/tool', array('static_export', array('utheme' => $GLOBALS['FORUM_DRIVER']->get_theme('')), get_page_zone('static_export')), make_string_tempcode('Export static site (tar)')),
