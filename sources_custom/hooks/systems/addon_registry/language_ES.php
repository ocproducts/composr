...
Translations may also be downloaded directly from Transifex.';
    ...
    public function get_file_list()
    {
        return array(
            ...
            'lang_custom/ES/amazon.ini',
            'lang_custom/ES/bank.ini',
            'lang_custom/ES/booking.ini',
            'lang_custom/ES/browser_upgrade_suggest.ini',
            'lang_custom/ES/buildr.ini',
            'lang_custom/ES/buttons.ini',
            'lang_custom/ES/classifieds.ini',
            'lang_custom/ES/cloundinary.ini',
            'lang_custom/ES/community_billboard.ini',
            'lang_custom/ES/composr_homesite.ini',
            'lang_custom/ES/composr_mobile_sdk.ini',
            'lang_custom/ES/customers.ini',
            'lang_custom/ES/disastr.ini',
            'lang_custom/ES/downloads_followup_email.ini',
            'lang_custom/ES/ebay.ini',
            'lang_custom/ES/facebook.ini',
            'lang_custom/ES/gallery_syndication.ini',
            'lang_custom/ES/gallery_syndication_vimeo.ini',
            'lang_custom/ES/gallery_syndication_youtube.ini',
            'lang_custom/ES/giftr.ini',
            'lang_custom/ES/google_map.ini',
            'lang_custom/ES/google_map_users.ini',
            'lang_custom/ES/google_search.ini',
            'lang_custom/ES/image_slider.ini',
            'lang_custom/ES/insults.ini',
            'lang_custom/ES/iotds.ini',
            'lang_custom/ES/jestr.ini',
            'lang_custom/ES/member_comments.ini',
            'lang_custom/ES/mentorr.ini',
            'lang_custom/ES/nested_csv.ini',
            'lang_custom/ES/oauth.ini',
            'lang_custom/ES/phpdoc.ini',
            'lang_custom/ES/referrals.ini',
            'lang_custom/ES/related.ini',
            'lang_custom/ES/report_content.ini',
            'lang_custom/ES/similar_sites.ini',
            'lang_custom/ES/sites.ini',
            'lang_custom/ES/sortable_tables.ini',
            'lang_custom/ES/stealr.ini',
            'lang_custom/ES/tapatalk.ini',
            'lang_custom/ES/tester.ini',
            'lang_custom/ES/tutorials.ini',
            'lang_custom/ES/twitter.ini',
            'lang_custom/ES/twitter_feed.ini',
            'lang_custom/ES/unslider.ini',
            'lang_custom/ES/video_cnn.ini',
            'lang_custom/ES/video_syndication_photobucket.ini',
            'lang_custom/ES/weather.ini',
            'lang_custom/ES/workflows.ini',
            'lang_custom/ES/youtube_channel.ini',
        );
    }
}
