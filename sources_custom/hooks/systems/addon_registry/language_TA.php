...
Translations may also be downloaded directly from Transifex.';
    ...
    public function get_file_list()
    {
        return array(
            ...
            'adminzone/pages/comcode_custom/TA/comcode_whitelist.txt',
            'adminzone/pages/comcode_custom/TA/insults.txt',
            'adminzone/pages/comcode_custom/TA/referrals.txt',
            'buildr/pages/comcode_custom/TA/docs.txt',
            'buildr/pages/comcode_custom/TA/rules.txt',
            'buildr/pages/comcode_custom/TA/start.txt',
            ...
            'lang_custom/TA/tapatalk.ini',
            'lang_custom/TA/facebook.ini',
            'lang_custom/TA/composr_homesite.ini',
            'lang_custom/TA/activities.ini',
            'lang_custom/TA/twitter.ini',
            'lang_custom/TA/google_map_users.ini',
            'lang_custom/TA/google_map.ini',
