...
class Hook_health_check_marketing_seo_robotstxt extends Hook_Health_Check
{
    ...
    */
    ...
    {
        $this->process_checks_section('testRobotsTxtValidity', 'robots.txt validity', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testRobotsTxtCorrectness', 'robots.txt correctness', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testRobotsTxtCompleteness', 'robots.txt completeness', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testRobotsTxtSitemapLinkage', 'Sitemap linkage', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
