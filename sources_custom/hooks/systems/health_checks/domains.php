...
class Hook_health_check_domains extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testDNSResolution', 'DNS resolution', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testDomainExpiry', 'Domain expiry', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
