...
class Hook_health_check_email extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testEmailQueue', 'E-mail queue', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testEmailConfiguration', 'E-mail configuration', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testSPF', 'SPF', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testEmailOperation', 'E-mail operation', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testSMTPBlacklisting', 'SMTP blacklisting', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
