...
class Hook_health_check_stability extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testManualLogs', 'Manual stability checks', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testPageIntegrity', 'Page integrity', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testBlockIntegrity', 'Block integrity', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testErrorLog', 'Error log', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
