...
class Hook_health_check_marketing extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testManualSocialMedia', 'Social media', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testManualAnalytics', 'Analytics', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testGoogleAnalytics', 'Google Analytics', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
