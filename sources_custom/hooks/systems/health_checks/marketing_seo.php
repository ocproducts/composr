...
class Hook_health_check_marketing_seo extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testManualSEO', 'Manual SEO checks', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testMetaDescription', 'Meta description', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testMetaKeywords', 'Meta keywords', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testPageTitle', 'Page titles', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testH1Tags', 'H1 tags', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testXMLSitemap', 'XML Sitemap', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
