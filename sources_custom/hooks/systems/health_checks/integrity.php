...
class Hook_health_check_integrity extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testFileIntegrity', 'File integrity', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testDatabaseIntegrity', 'Database integrity', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testDatabaseCorruption', 'Database corruption', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testUpgradeCompletion', 'Upgrade completion', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
