...
class Hook_health_check_security_hackattack extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testOverseasAccess', 'Overseas access', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testHackAttacks', 'Hack-attacks', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testFailedLogins', 'Failed logins', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testRateLimitSpike', 'Rate-limit spiking', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
