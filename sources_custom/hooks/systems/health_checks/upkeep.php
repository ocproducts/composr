...
class Hook_health_check_upkeep extends Hook_Health_Check
{
    ...
    {
        $this->process_checks_section('testComposrVersion', 'Composr version', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testPHPVersion', 'PHP version', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testAdminAccountStaleness', 'Admin account staleness', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testCopyrightDate', 'Copyright date', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testStaffChecklist', 'Staff checklist', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
