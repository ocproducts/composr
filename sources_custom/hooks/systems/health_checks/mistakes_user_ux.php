...
class Hook_health_check_mistakes_user_ux extends Hook_Health_Check
{
    ...
    public function run($check_context, $manual_checks = false, $automatic_repair = false, $use_test_data_for_pass = null)
    {
        ...
        $this->process_checks_section('testWWWRedirection', 'www redirection', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
        $this->process_checks_section('testHTTPSRedirection', 'HTTPS redirection', $check_context, $manual_checks, $automatic_repair, $use_test_data_for_pass);
