...
$decision_tree = array(
    ...
    'project' => array(
        ...
        'questions' => array(
            ...
            'country' => array(
                'label' => 'Country',
                'description' => 'What country do you work in?',
                'type' => 'short_text',
    ...
    'project_qs_development' => array(
        ...
        'questions' => array(
            'features' => array(
                ...
                'type' => 'list_multi',
                'default' => 'News/Blogs|Page editing',
                'default_list' => array(
            ...
            'mobile' => array(
                ...
                'type' => 'list_multi',
                'default' => 'Separate optimised mobile/desktop modes|Basic responsive design',
                'default_list' => array(
    ...
    'project_qs_design' => array(
        ...
        'questions' => array(
            'visual_appeal' => array(
                ...
                'type' => 'list',
                'default' => 'The design must be on par with other good web sites.',
                'default_list' => array(
                    'The design must look better than the current generation of top sites. It should be able to win top design awards.',
                    'The design must be able to equal other top sites out there (house-hold brands, for example), and stun visitors.',
            ...
            'front_page' => array(
                ...
                'default' => '',
                'default_list' => array(
                    'Very simple home page that is just a headline and description laid on top of an edge-to-edge image or video',
                    'Image/video/text slider for front page (multiple animating slides, to catch user attention)',
                    'Include syndicated industry news from other website(s)',
                    'Animated images come alive as you scroll the page',
                    'Infinite scrolling of content (more content loads from the server as you keep scrolling, no need to click next)',
            ...
            'global_layout' => array(
                ...
                'type' => 'list_multi',
                'default' => 'Drop-down/hamburger menus|Prominent search box',
                'default_list' => array(
                    'Banner advertising',
            ...
            'design_direction' => array(
                ...
                'default_list' => array(
                    ...
                    'Automatic share/subscribe/signup requests (e.g. when scrolling to end of content, or in a timed overlay)',
                    ...
                    'Fancy arrangement of content on pages (e.g. tabbed interfaces, accordions, or other special effects)',
            ...
            'website_design' => array(
                ...
                'default_list' => array(
                    ...
                    'Produce advanced site help (e.g. a video, an interactive walk-through, or a significant document)',
    ...
    'project_qs_deployment' => array(
        ...
        'questions' => array(
            ...
            'deployment' => array(
                ...
                'type' => 'list_multi',
                'default' => 'Set up Google Analytics|SSL certificate setup (the padlock icon in the browser toolbar)|Setting up of automatic downtime alerts ("uptime monitoring")',
                'default_list' => array(
    ...
    'project_qs_maintenance' => array(
        ...
        'text' => 'It is usually not a good idea to think of a web project as something that is finished when launched. To stay competitive, and to achieve results, you may need ongoing testing and tuning of your systems.',
        ...
        'questions' => array(
            'maintenance' => array(
                ...
                'type' => 'list_multi',
                'default' => 'Priority patching for security vulnerabilities|Developer hours each month for unspecified maintenance and support|Security audit/review of logs and system software',
                'default_list' => array(
            ...
            'goals_optimisation' => array(
                ...
                'type' => 'list_multi',
                'default' => 'Regular SEO performance reviews (i.e. Google optimisation)|Regular analytics reviews (seeing how your traffic is growing, and spotting stumbling blocks with how users interact with your site)',
                'default_list' => array(
                    'Regular SEO performance reviews (i.e. Google optimisation)',
                    'Regular analytics reviews (seeing how your traffic is growing, and spotting stumbling blocks with how users interact with your site)',
    ...
    'support' => array(
        ...
        'questions' => array(
            ...
            'response_time' => array(
                'label' => 'Response time',
                'description' => 'Expected response time. This is not guaranteed, but we\'ll try and meet it. Most customers will want our regular reply response time, which provides the service level that most customers would expect from us. A back-burner reply, or late regular reply, uses [page="_SEARCH:commercial_support" external="1"]fewer support credits[/page].',
                'type' => 'list',
