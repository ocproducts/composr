...
<a data-tpl="menuMobile" data-tpl-params="{+START,PARAMS_JSON,menu_id}{_*}{+END}" href="{$PAGE_LINK*,:sitemap}" class="mobile-menu-button js-click-toggle-{$GET,menu_id}-content"><img src="{$IMG*,mobile_menu}" alt="{!MENU}" />	<span>{!MENU}</span></a>
