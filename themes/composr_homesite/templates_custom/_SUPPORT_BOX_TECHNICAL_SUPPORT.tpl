...
<p>
	Please note that moderate to large programming projects are better suited for secondment or our
	<a href="{$PAGE_LINK*,ocproducts:}" title="Agency service {!LINK_NEW_WINDOW}" target="_blank">agency service</a>
</p>

<div class="commonBtn margin-l-20">
	<a href="{$PAGE_LINK*,:contact:support}">Ask your question</a>
</div>
