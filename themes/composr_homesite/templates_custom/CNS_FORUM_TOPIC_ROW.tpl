	...
	<td class="cns_forum_topic_row_preview cns_column2">
		{+START,IF,{$NOT,{$MOBILE}}}
			...
			<div class="cns_forum_topic_title_bits">
				...
				<a class="vertical_alignment {+START,IF_NON_EMPTY,{TOPIC_ROW_MODIFIERS}{TOPIC_ROW_LINKS}} cns_forum_topic_indent{+END}{+START,IF,{UNREAD}} cns_unread_topic_title{+END}" href="{URL*}" title="{$ALTERNATOR_TRUNCATED,{TITLE},60,{!TOPIC_STARTED_DATE_TIME,{HOVER;~}},,1}">{$TRUNCATE_LEFT,{$PROVIDE_WITH_TRANSLATION,{TITLE},{$TRANS_TEXT_CONTEXT_plain}},46,1}</a>
