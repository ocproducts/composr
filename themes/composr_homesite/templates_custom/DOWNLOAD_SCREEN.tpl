					...
					{+END}
						<div class="download_now" itemprop="significantLinks">
							{+START,IF,{MAY_DOWNLOAD}}
								<p class="download_link associated_link suggested_link"><a{+START,INCLUDE,_DOWNLOAD_BUTTON}{+END} rel="nofollow" href="{DOWNLOAD_URL*}"><strong>{!DOWNLOAD_NOW}</strong></a></p>
							{+END}
