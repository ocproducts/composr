...
<body style="margin:0; padding:0; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; font-size:13px;" class="email_body">
<div style="background:#fff;" class="email_body">
	<div class="email_logo"><a href="{$BASE_URL*}"><img alt="Composr logo" src="{$IMG*,logo/standalone_logo}" /></a></div>
