...
<iframe style="width: 100%; height: 700px" frameborder="0" style="border: 0" src="https://kiwiirc.com/client/irc.kiwiirc.com/?nick={$USERNAME&*}#composrcms"></iframe>

<p>
	Our goal is to make it really easy to talk to other Composr users to help each other.<br /><br />
	Want to help out by hanging out here longer-term? Set up an IRC client on your machine to automatically connect to the Freenode #composrcms channel.<br /><br />
