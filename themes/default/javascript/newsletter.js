(function ($, Composr) {
    ...
    Composr.behaviors.newsletter = {
        initialize: {
            attach: function (context) {
                Composr.initializeTemplates(context, 'newsletter');
            }
        }
    };

    Composr.templates.newsletter = {
        newsletterPreview: function (options) {
            newsletterPreviewInto('preview_frame', options.htmlPreview);
        }
    };

    function newsletterPreviewInto(frame_id, html) {
