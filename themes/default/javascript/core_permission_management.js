(function (Composr) {
    ...
    Composr.behaviors.corePermissionManagement = {
        initialize: {
            attach: function (context) {
                Composr.initializeViews(context, 'core_permission_management');
                Composr.initializeTemplates(context, 'core_permission_management');
            }
        }
    };

    var PermissionsTreeEditorScreen = Composr.View.extend({
        initialize: function (v, options) {
            PermissionsTreeEditorScreen.__super__.initialize.apply(this, arguments);
        ...
        updateGroupDisplayer: function (e, select) {
            ...
            window.sitemap.render_tree(window.sitemap.tree_list_data, tree);
        },
    ...
    Composr.views.corePermissionManagement = {
        PermissionsTreeEditorScreen: PermissionsTreeEditorScreen
    };
