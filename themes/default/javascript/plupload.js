...
(function ($cms) {
    ...
    function preinitFileInput(pageType, name, postingFieldName, filter) {
        ...
        $dom.append(
            ...
            '<button type="button" id="upload-button-' + name + '" class="buttons--upload button-micro">{!BROWSE;^*}</button>' +
            '<button type="button" id="fs-clear-' + name + '" class="buttons--clear button-micro clear-button" alt="{!CLEAR;^*}">{!CLEAR;^*}</button>' +
            '</div>' +
    ...
    function getUploaderSettings(name, pageType, postingFieldName, filter) {
        ...
        return {
            ...
            // Flash settings
            flash_swf_url: $util.rel('data/plupload/plupload.flash.swf'),

            // Silverlight settings
            silverlight_xap_url: $util.rel('data/plupload/plupload.silverlight.xap'),
