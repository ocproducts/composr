...
(function (window) {
    ...
    function SoundManager(smURL, smID) {
        ...
        var SMSound,
            ...
            hasConsole = (window.console !== undefined && console.log !== undefined),
            isFocused = (doc.hasFocus !== undefined ? doc.hasFocus() : null),
            tryInitOnFocus = (isSafari && (doc.hasFocus === undefined || !doc.hasFocus())),
        ...
        this.setVolume = function (sID, nVol) {
            var i, j;
            if (sID !== undefined && !isNaN(sID) && nVol === undefined) {
        ...
        getDocument = function () {
            return (doc.body || doc.querySelector('div'));
        };
        id = function (sID) {
        ...
        html5_events = {
            ...
            canplay: html5_event(function () {
                ...
                s._onbufferchange(0);
                position1K = (s._iO.position !== undefined && !isNaN(s._iO.position) ? s._iO.position / msecScale : null);
        ...
        catchError = function (options) {
            ...
            if (typeof sm2.onerror === 'function') {
                sm2.onerror.apply(window, [{
                    type: (options.type !== undefined ? options.type : null)
                }]);
            }
