(function ($cms, $util, $dom) {
    ...
    $dom.illustrateFrameLoad = function illustrateFrameLoad(iframeId) {
        ...
        $dom.html(doc.body, '<div aria-busy="true" class="spaced"><div class="ajax_loading"><img id="loading_image" class="vertical-alignment" src="' + $util.srl('{$IMG*;,loading}') + '" alt="{!LOADING;^}" /> <span class="vertical-alignment">{!LOADING;^}<\/span><\/div><\/div>');
