		...
		<div class="float-surrounder">
			<div class="buildr-room-chat results-table">
				...
				<form method="post" id="posting-form" action="{$PAGE_LINK*,_SELF:_SELF}" autocomplete="off">
					...
					</select> <input class="button-screen-item buttons--send" type="submit" value="{!SEND_MESSAGE}" /></div>
				</form>
			</div>
	...
	<div class="buildr-centered-contents">
						...
						{+START,IF_NON_EMPTY,{ITEMS_HELD}}
							<tr>
								...
								<td>
									...
									<input class="button-screen-item buttons--proceed" type="submit" value="{!PROCEED}" />
								</td>
							</tr>
		...
		<div class="box box---w-main-screen" data-toggleable-tray="{}">
			<h2 class="toggleable-tray-title js-tray-header">
				...
				<a class="js-click-set-hidemod-cookie toggleable-tray-button js-tray-onclick-toggle-tray" href="#!"><img alt="{!EXPAND}" title="{!EXPAND}" width="24" height="24" src="{$IMG*,icons/trays/expand}" /></a>
			</h2>
