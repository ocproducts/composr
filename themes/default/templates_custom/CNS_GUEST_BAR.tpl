...
<section id="tray_{!MEMBER|}" data-require-javascript="facebook_support" data-tpl="cnsGuestBar" data-toggleable-tray="{ cookie: '{!MEMBER|}' }" class="box cns_information_bar_outer">
