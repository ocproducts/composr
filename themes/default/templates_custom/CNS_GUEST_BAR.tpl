...
<section data-require-javascript="facebook_support" data-tpl="cnsGuestBar" id="tray_{!MEMBER|}" data-view="ToggleableTray" data-tray-cookie="{!MEMBER|}" class="box cns_information_bar_outer">
