			...
			<p>
				{+START,LOOP,SYNDICATIONS}
					{+START,IF,{SYNDICATION_IS_SET}}
						<button class="button-screen-item buttons--cancel" data-disable-on-click="1" type="submit" id="syndicate_stop__{_loop_key*}" name="syndicate_stop__{_loop_key*}">{!STOP_SYNDICATING_TO,{SYNDICATION_SERVICE_NAME*}}</button>
					{+END}
