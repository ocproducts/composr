					...
					<table class="map-table autosized-table login-page-form">
						<tbody>
							<tr>
								...
								<td>
									<input maxlength="80" type="text" value="{USERNAME*}" id="login_username" class="form-control form-control-inline" name="login_username" size="25" />
								</td>
							</tr>
							<tr>
								<th class="de-th"><label for="password">{!PASSWORD}:</label></th>
								<td>
									<input maxlength="255" type="password" id="password" class="form-control form-control-inline" name="password" size="25" />
								</td>
							</tr>
						</tbody>
					</table>
