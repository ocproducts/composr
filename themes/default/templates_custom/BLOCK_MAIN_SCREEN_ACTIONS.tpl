<aside role="navigation" class="screen_actions_outer box"><div class="screen_actions box_inner">
	...
	<div class="recommend"><a onclick="return open_link_as_overlay(this);" class="link_exempt" target="_blank" title="{!CMS_RECOMMEND} {!LINK_NEW_WINDOW}" href="{RECOMMEND_URL*}"><span>{!CMS_RECOMMEND}</span></a></div>
