...
<div data-require-javascript="sortable_tables" data-tpl="sortableTable" class="wide-table-wrap">
	<table id="sortable_table_{ID*}" class="results-table wide-table columned-table autosized-table sortable_table table-autosort:{DEFAULT_SORT_COLUMN*} table-autofilter table-autopage:{MAX*}">
		<thead>
			<tr>
				{+START,LOOP,HEADERS}
