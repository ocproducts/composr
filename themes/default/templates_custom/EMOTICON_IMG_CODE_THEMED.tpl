...
{+START,IF,{$IS_IN_GROUP,{$CONFIG_OPTION,jestr_emoticon_magnet_shown_for}}}
	...
	<div id="emoticoncrazy{$GET%,rndx}" data-require-javascript="['core_rich_media', 'jestr']" data-tpl="emoticonImgCodeThemedJestr" data-tpl-params="{+START,PARAMS_JSON,is_in_group,img_src,rndx}{_*}{+END}"></div>
{+END}
