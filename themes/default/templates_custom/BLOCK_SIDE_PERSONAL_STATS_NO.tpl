		...
		<form title="{!_LOGIN}" class="js-submit-check-username-for-blankness" action="{LOGIN_URL*}" method="post" autocomplete="on">
			...
			<div>
				<div>
					...
					<input maxlength="80" class="form-control login-block-username" type="text" placeholder="{!USERNAME}" id="ps-login-username" name="login_username" />
					<div class="accessibility-hidden"><label for="ps-password">{!PASSWORD}</label></div>
					<input maxlength="255" class="form-control" type="password" placeholder="{!PASSWORD}" name="password" id="ps-password" />
				</div>
