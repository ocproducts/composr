...
{+START,IF_NON_EMPTY,{$CONFIG_OPTION,facebook_appid}}
	...
	<div id="fb-root" data-require-javascript="facebook_support" data-tpl="facebookFooter" data-tpl-params="{+START,PARAMS_JSON,facebook_appid,fb_connect_finishing_profile,fb_connect_logged_out,fb_connect_uid}{_*}{+END}"></div>
{+END}
