...
{+START,IF_NON_PASSED_OR_FALSE,WYSIWYG_EDITABLE}
	{+START,IF,{$AND,{FRAMED},{THUMB}}}
		{+START,IF,{$HAS_ZONE_ACCESS,adminzone}}
			<p class="associated_link associated_links_block_group"{+START,IF_NON_EMPTY,{WIDTH}}{+START,IF,{$NEQ,{WIDTH}x{HEIGHT},{$CONFIG_OPTION,thumb_width}x{$CONFIG_OPTION,thumb_width}}} style="width: {$ADD*,{WIDTH},10}px"{+END}{+END}>
