				...
				{+START,LOOP,PRICES}
					<tr>
						<td>
							...
							<select name="catalogue_{ID*}" id="catalogue_{ID*}" class="form-control form-control-inline">
						...
						<td>
							...
							<input maxlength="5" name="days_{ID*}" id="days_{ID*}" value="{PRICE_DAYS*}" class="form-control form-control-inline input-integer" type="number" data-prevent-input="[^\-\d{$BACKSLASH}{$DECIMAL_POINT*}]" />
						</td>
						<td>
							<label for="label_{ID*}" class="accessibility-hidden">{!TITLE}</label>
							<input maxlength="255" name="label_{ID*}" id="label_{ID*}" value="{PRICE_LABEL*}" class="form-control form-control-inline input-line" size="30" type="text" />
						</td>
						<td>
							<label for="price_{ID*}" class="accessibility-hidden">{!PRICE}</label>
							<input maxlength="10" name="price_{ID*}" id="price_{ID*}" value="{PRICE_PRICE*}" class="form-control form-control-inline input-float" step="0.01" type="number" data-prevent-input="[^\-\d{$BACKSLASH}{$DECIMAL_POINT*}]" />
						</td>
					</tr>
				{+END}
			</tbody>
