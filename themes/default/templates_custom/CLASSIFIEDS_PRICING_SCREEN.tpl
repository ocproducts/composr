				...
				{+START,LOOP,PRICES}
					<tr>
						...
						<td>
							...
							<input maxlength="5" name="days_{ID*}" id="days_{ID*}" value="{PRICE_DAYS*}" class="input-integer" type="number" data-prevent-input="[^\-\d{$BACKSLASH}{$DECIMAL_POINT*}]" />
						</td>
						<td>
						...
						<td>
							...
							<input maxlength="10" name="price_{ID*}" id="price_{ID*}" value="{PRICE_PRICE*}" class="input-float" step="0.01" type="number" data-prevent-input="[^\-\d{$BACKSLASH}{$DECIMAL_POINT*}]" />
						</td>
					</tr>
				{+END}
			</tbody>
