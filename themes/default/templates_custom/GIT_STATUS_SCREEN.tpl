...
<form id="git_status_form" data-view="GitStatus" action="{$SELF_URL*,0,0,0,type=action,include_ignored={INCLUDE_IGNORED}}" method="post">
			...
			<tr>
				<td colspan="6">
					{+START,IF,{$NOT,{INCLUDE_IGNORED}}}
						<button id="button_local_tar" class="button-screen-item buttons--all js-btn-refresh-with-ignored" type="submit">{+START,INCLUDE,ICON}NAME=buttons/all{+END} Refresh with ignored files</button>
					{+END}
					{+START,IF,{INCLUDE_IGNORED}}
						<button id="button_local_tar" class="button-screen-item buttons--all2 js-btn-refresh-without-ignored" type="submit">{+START,INCLUDE,ICON}NAME=buttons/all2{+END} Refresh without ignored files</button>
					{+END}
					...
					<button id="button_revert" class="button-screen-item menu--admin--delete js-btn-delete-local-changes" type="submit" disabled="disabled">{+START,INCLUDE,ICON}NAME=menu/_generic_admin/delete{+END} Delete/revert files</button>
