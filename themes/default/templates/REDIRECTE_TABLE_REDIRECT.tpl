<tr class="{$CYCLE,results_table_zebra,zebra_0,zebra_1}">
	...
	<td>
		...
		<input onmouseover="activate_tooltip(this,event,'{!IS_TRANSPARENT_REDIRECT;}','40%');" title="{!IS_TRANSPARENT_REDIRECT}" class="input_tick" type="checkbox" id="{NAME*}" name="{NAME*}"{+START,IF,{TICKED}} checked="checked"{+END} value="1" />
	</td>
	<td>
		{+START,IF,{$NEQ,{I},new}}
