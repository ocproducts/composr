...
<img alt="{$STRIP_TAGS,{CAPTION}}"{+START,IF_PASSED,ROLLOVER} id="{$GET%,RAND_ID_IMG}"{+END}
	...
	{+START,IF_PASSED,WIDTH}width="{WIDTH*}"{+END}
	{+START,IF_PASSED,HEIGHT}height="{HEIGHT*}"{+END}
	data-tpl="comcodeImg" data-tpl-params="{+START,PARAMS_JSON,ROLLOVER,REFRESH_TIME}{_*}{+END}" />