	...
	{+START,SET,posting_box}
		<div class="chat-posting-area">
			<div class="float-surrounder">
				...
				<div class="right">
					<a class="toggleable-tray-button js-btn-toggle-chat-comcode-panel" href="#!"><img id="e-chat-comcode-panel" width="20" height="20" src="{$IMG*,icons/trays/expand}" alt="{!CHAT_TOGGLE_COMCODE_BOX}" title="{!CHAT_TOGGLE_COMCODE_BOX}" /></a>
				</div>
	...
	<form title="{$STRIP_TAGS,{!CHAT_OPTIONS_DESCRIPTION}}" class="below-main-chat-window js-form-submit-check-chat-options" method="post" action="{OPTIONS_URL*}" autocomplete="off">
		...
		<div class="box box---chat-screen-options box-prominent"><div class="box-inner">
			...
			<div class="chat-room-options">
				...
				<p>
					<button class="button-screen-item buttons--save" data-cms-confirm-click="{!SAVE_COMPUTER_USING_COOKIE*}" type="submit">{+START,INCLUDE,ICON}NAME=buttons/save{+END} {$STRIP_TAGS,{!CHAT_CHANGE_OPTIONS}}</button>
				</p>
			</div>
