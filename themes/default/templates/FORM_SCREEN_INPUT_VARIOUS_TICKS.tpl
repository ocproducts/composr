...
<div data-view-core="ToggleableTray" data-tpl-core-form-interfaces="formScreenInputVariousTricks" data-tpl-args="{+START,PARAMS_JSON,CUSTOM_NAME,CUSTOM_ACCEPT_MULTIPLE}{_*}{+END}">
