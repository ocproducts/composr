<div class="comcode_supported">
	...
	<ul class="horizontal_links horiz_field_sep">
		...
		{+START,IF,{$AND,{$JS_ON},{W}}}
			<li><a rel="nofollow" id="toggle_wysiwyg_{NAME*}" href="#!" onclick="toggle_wysiwyg('{NAME;*}');"><abbr title="{!comcode:TOGGLE_WYSIWYG_2}"><img src="{$IMG*,icons/16x16/editor/wysiwyg_on}" srcset="{$IMG*,icons/32x32/editor/wysiwyg_on} 2x" alt="{!comcode:ENABLE_WYSIWYG}" title="{!comcode:ENABLE_WYSIWYG}" class="vertical_alignment" /></abbr></a></li>
		{+END}
	</ul>
</div>
