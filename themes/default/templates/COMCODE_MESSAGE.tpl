<div class="comcode_supported">
	...
	<ul class="horizontal_links horiz_field_sep">
		{+START,IF,{$SHOW_DOCS}}{+START,IF_PASSED,URL}
			<li><a data-open-as-overlay="{}" class="link_exempt" title="{!COMCODE_MESSAGE,Comcode} {!LINK_NEW_WINDOW}" target="_blank" href="{URL*}"><img src="{$IMG*,icons/16x16/editor/comcode}" srcset="{$IMG*,icons/32x32/editor/comcode} 2x" class="vertical_alignment" alt="" /></a></li>
		{+END}{+END}
