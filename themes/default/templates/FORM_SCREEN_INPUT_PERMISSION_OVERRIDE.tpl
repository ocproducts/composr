...
<td class="form-table-field-input privilege-cell" data-view="FormScreenInputPermissionOverride" data-view-params="{+START,PARAMS_JSON,GROUP_ID,DEFAULT_ACCESS,PRIVILEGE,TITLE,ALL_GLOBAL}{_*}{+END}">
	...
	<select class="form-control form-control-inline js-click-perms-overridden js-change-perms-overridden js-mouseover-show-perm-setting" tabindex="{TABINDEX*}" title="{TITLE*}" id="access_{GROUP_ID*}_privilege_{PRIVILEGE*}" name="access_{GROUP_ID*}_privilege_{PRIVILEGE*}">
