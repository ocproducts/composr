...
<td class="form-table-field-input privilege_cell" data-view="FormScreenInputPermissionOverride" data-view-params="{+START,PARAMS_JSON,GROUP_ID,DEFAULT_ACCESS,PRIVILEGE,TITLE,ALL_GLOBAL}{_*}{+END}">
