...
<div data-tpl="comcodeMemberLink" data-tpl-params="{+START,PARAMS_JSON,MEMBER_ID}{_*}{+END}">
	{+START,IF,{$NOT,{$TAPATALK}}}
		<span class="comcode-member-link js-mouseover-comcode-member-link js-focus-comcode-member-link js-mouseout-comcode-member-link" data-blur-deactivate-tooltip="">
