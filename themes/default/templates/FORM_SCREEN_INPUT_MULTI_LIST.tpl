...
<div data-tpl="formScreenInputMultiList">
	<select multiple="multiple" size="{SIZE*}" tabindex="{TABINDEX*}" class="input-list form-control" id="{NAME*}" name="{NAME*}[]"{+START,IF,{$EQ,{SIZE},5}} data-cms-select2="{dropdownAutoWidth: true, containerCssClass: 'wide-field'}"{+END}>
		{CONTENT}
	</select>
