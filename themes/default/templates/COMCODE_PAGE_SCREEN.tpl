			...
			{+START,IF,{IS_PANEL}}
				{+START,IF,{$EQ,{NAME},panel_left,panel_right}}
					<p class="quick_self_edit_link associated_link">
						<a data-open-as-overlay="{}" class="link_exempt" title="{!COMCODE_MESSAGE,Comcode} {!LINK_NEW_WINDOW}" target="_blank" href="{$PAGE_LINK*,_SEARCH:userguide_comcode}"><img alt="" width="16" height="16" src="{$IMG*,icons/16x16/editor/comcode}" srcset="{$IMG*,icons/32x32/editor/comcode} 2x" /></a>
