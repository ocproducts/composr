				...
				<div class="comments_posting_form_end">
					...
					<div class="proceed_button buttons_group">
						...
						{+START,IF,{$BROWSER_MATCHES,simplified_attachments_ui}}
							<input tabindex="7" onclick="start_simplified_upload('post');" class="buttons__thumbnail {$?,{$IS_EMPTY,{COMMENT_URL}},button_screen,button_screen_item}" type="button" value="{!comcode:ADD_IMAGES}" />
						{+END}
