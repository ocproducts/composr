		...
		{+START,IF,{USE_CAPTCHA}}
			<div class="comments_captcha">
				<div class="box box___comments_posting_form__captcha"><div class="box_inner">
					<p><label for="captcha">{!DESCRIPTION_CAPTCHA_2,<a onclick="return play_self_audio_link(this);" target="_blank" title="{!AUDIO_VERSION} {!LINK_NEW_WINDOW}" href="{$FIND_SCRIPT*,captcha,1}?mode=audio{$KEEP*,0,1}">{!AUDIO_VERSION}</a>}</label></p>
