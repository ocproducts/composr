...
{+START,SET,hero_slider}{+START,IF,{$ADDON_INSTALLED,galleries}}{+START,IF,{$THEME_OPTION,homepage_slider_enabled}}{+START,IF,{$OR,{$MATCH_KEY_MATCH,:home},{$MATCH_KEY_MATCH,site:home}}}
	{$BLOCK,block=main_hero_slider,block_id=homepage-hero,gallery_name={$THEME_OPTION,homepage_slider_gallery},blank_if_empty=1,effect={$THEME_OPTION,homepage_slider_effect},interval={$THEME_OPTION,homepage_slider_cycle_duration},fullscreen={$THEME_OPTION,homepage_slider_fullscreen},show_scroll_down=1,check_perms=0}
{+END}{+END}{+END}{+END}
			...
			<footer class="footer clearfix" itemscope="itemscope" itemtype="http://schema.org/WPFooter" role="contentinfo">
				<div class="footer-inner container">
					<div class="global-footer-left block-desktop">
						...
						{+START,IF,{$HAS_SU}}
						<form title="{!SU} {!LINK_NEW_WINDOW}" class="inline su-form" method="get" action="{$URL_FOR_GET_FORM*,{$SELF_URL,0,1}}" target="_blank">
						...
						<form title="{!SCREEN_DEV_TOOLS} {!LINK_NEW_WINDOW}" class="inline special-page-type-form js-global-submit-staff-actions-select" action="{$URL_FOR_GET_FORM*,{$SELF_URL,0,1}}" method="get" target="_blank">
