...
{+START,IF,{$GET,js_menu}}
	...
	<nav id="{$GET*,menu_sitemap_id}" class="menu_type__sitemap" data-tpl="menuSitemap" data-tpl-params="{+START,PARAMS_JSON,menu_sitemap_id}{_*}{+END}" data-tp-menu-content="{$TRIM*,{CONTENT}}">
