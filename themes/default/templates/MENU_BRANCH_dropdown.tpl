{+START,SET,branch}
	...
	{+START,IF,{$NOT,{TOP_LEVEL}}}
		<li {+START,IF,{$GET,HAS_CHILDREN}} onmousemove="/*Access-note: checked*/return pop_up_menu('{MENU|;*}_dexpand_{$GET;*,RAND}',null,'{MENU|;*}_d',event);"{+END} class="nlevel {$?,{CURRENT},current,non_current} has_img" onclick="/*Access-note: checked*/click_link(this.querySelector('a'));">
