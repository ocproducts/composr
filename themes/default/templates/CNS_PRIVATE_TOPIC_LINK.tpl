<div class="topic_list_topic notification_{$?,{HAS_READ},has_read,has_not_read}">
	<img class="right spaced" src="{$?*,{$IS_EMPTY,{$AVATAR,{WITH_POSTER_ID}}},{$IMG,cns_default_avatars/default},{$AVATAR,{WITH_POSTER_ID}}}" title="{!WITH_SIMPLE,{$DISPLAYED_USERNAME*,{WITH_USERNAME}}}" alt="{!WITH_SIMPLE,{$DISPLAYED_USERNAME*,{WITH_USERNAME}}}" />
