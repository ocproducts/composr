<div class="topic_list_topic notification_{$?,{HAS_READ},has_read,has_not_read}">
	...
	<div class="topic_list_title">
		<a onclick="poll_for_notifications(true,true); return open_link_as_overlay(this);" title="{!POST_PLU,{NUM_POSTS*}}, {TITLE*~}" href="{TOPIC_URL*}">{$TRUNCATE_LEFT,{TITLE},30,0,1}</a><br />
