			...
			{+START,IF_NON_EMPTY,{REVIEW_RATING}}
				{+START,IF_EMPTY,{REVIEW_TITLE}}
					{+START,WHILE,{$LT,{$GET,rating_loop},{$ROUND,{$DIV_FLOAT,{REVIEW_RATING},2}}}}
						<img width="14" height="14" src="{$IMG*,icons/28x28/rating}" alt="{$ROUND,{$DIV_FLOAT,{REVIEW_RATING},2}}" />
						{$INC,rating_loop}
					{+END}
				{+END}
			{+END}
			...
			<div class="float-surrounder">
				<div class="comments-notification-buttons">
					{+START,INCLUDE,NOTIFICATION_BUTTONS}
						...
						BUTTON_TYPE=button-screen-item
				...
				<div class="comments-sorting-box">
					<form title="{!SORT}" class="inline" action="{$SELF_URL*}" method="post" autocomplete="off">
						...
						<select class="js-change-select-submit-form" id="comments_sort" name="comments_sort">
