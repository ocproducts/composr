<form title="{!COUNT_PAGES}" class="inline" action="{$URL_FOR_GET_FORM*,{URL}}" method="get" target="_self" autocomplete="off">
	...
	<div class="pagination_pages">
		...
		<select{+START,IF,{$JS_ON}} onchange="/*guarded*/if (!this.form.onsubmit || this.form.onsubmit()) this.form.submit();"{+END} id="blp_start{$GET*,RAND_PAGINATION_LIST_PAGES}" name="{START_NAME*}">
			{LIST}
