...
<div class="tpl-placeholder" style="display: none;" data-tpl="commentAjaxHandler" data-tpl-params="{+START,PARAMS_JSON,OPTIONS,HASH,url_stem,infinite_scroll}{_*}{+END}"></div>
