...
{+START,IF,{$EQ,{BLOCK_ID},small_version}}
	<div class="box box___block_main_image_fader" data-view-galleries="BlockMainImageFader" data-view-args="{+START,PARAMS_JSON,RAND_FADER_IMAGE,TITLES,HTML,IMAGES}{_*}{+END}">
		<div class="box_inner">
			<h2>{!MEDIA}</h2>
...
{+START,IF,{$NEQ,{BLOCK_ID},small_version}}
	<div class="gallery_tease_pic_wrap" data-view-galleries="BlockMainImageFader" data-view-args="{+START,PARAMS_JSON,RAND_FADER_IMAGE,TITLES,HTML,IMAGES}{_*}{+END}">
