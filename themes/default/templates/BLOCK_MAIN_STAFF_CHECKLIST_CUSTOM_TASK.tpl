...
<div data-view="BlockMainStaffChecklistCustomTask" data-view-params="{+START,PARAMS_JSON,ID,confirm_delete_message}{_*}{+END}" data-vw-task-done="{TASK_DONE*}" class="checklist-row js-click-mark-task js-keypress-mark-task">
	<div class="float-surrounder">
		<p class="checklist-task-status">
			...
			<a class="js-click-confirm-delete" href="#!"><img width="12" height="12" src="{$IMG*,checklist/cross}" title="{!DELETE}" alt="{!DELETE}: {$STRIP_TAGS,{TASK_TITLE}}" class="js-img-checklist-cross" /></a>
		</p>
		<p class="checklist-task">
			<img width="12" height="12" src="{$IMG*,checklist/{TASK_DONE}}" title="{!MARK_TASK_DONE}" alt="" class="js-img-checklist-status" />
