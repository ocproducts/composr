<div class="checklist_row" onclick="/*Access-note: checked*/{$?,{$EQ,{TASK_DONE},not_completed},mark_done,mark_undone}(this,{ID%});" onmouseover="this.getElementsByTagName('img')[0].setAttribute('src','{$IMG;*,checklist/cross2}');" onmouseout="this.getElementsByTagName('img')[0].setAttribute('src','{$IMG;*,checklist/cross}');">
