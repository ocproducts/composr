<form title="{!SORT}" action="{$URL_FOR_GET_FORM*,{URL}}{+START,IF_PASSED,HASH}#{HASH*}{+END}" method="get" class="inline" autocomplete="off">
	...
	<div class="inline">
		...
		<select {+START,IF,{$NOT,{$GET,show_sort_button}}} data-change-submit-form=""{+END} id="r-{$GET*,RAND_PAGINATION}" name="{SORT*}" class="form-control form-control-inline">
			{SELECTORS}
