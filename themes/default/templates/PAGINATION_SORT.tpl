	...
	<div class="inline">
		{+START,SET,sort_button}
			...
			{+START,IF_PASSED,FILTER}
				<input data-disable-on-click="1" class="button_micro buttons__filter" type="submit" title="{!PROCEED}{+START,IF_NON_EMPTY,{$GET,TEXT_ID}}: {$GET*,TEXT_ID}{+END}" value="{!PROCEED}" />
			{+END}
		{+END}
