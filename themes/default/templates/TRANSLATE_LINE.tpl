...
<tr data-tpl="translateLine">
	...
	<td class="translate-line-second js-mouseover-enable-textarea-translate-field">
		...
		<div>
			<textarea {+START,IF,{$EQ,{OLD},{CURRENT}}} disabled="disabled"{+END} class="wide-field translate-field js-textarea-translate-field" cols="60" rows="{+START,IF,{$EQ,{CURRENT},}}{$ADD,{$DIV,{$LENGTH,{OLD}},80},1}{+END}{+START,IF,{$NEQ,{CURRENT},}}{$ADD,{$DIV,{$LENGTH,{CURRENT}},80},1}{+END}" id="trans-{NAME*}" name="trans_{NAME*}">{CURRENT*}</textarea>
		</div>
	</td>
