...
<div role="dialog" class="comcode_overlay box" id="{$GET,RAND_ID_OVERLAY}" data-tpl="comcodeOverlay" data-tpl-args="{+START,PARAMS_JSON,ID,RAND_ID_OVERLAY,TIMEOUT,TIMEIN}{_*}{+END}"
