	...
	<form title="{!MESSAGE}" action="{MESSAGES_PHP*}?action=post" method="post" autocomplete="off">
		...
		{+START,SET,posting_box}
			<div class="im-post-bits">
				...
				{+START,IF,{$CNS}}
					<a rel="nofollow" class="horiz-field-sep js-click-open-chat-emoticons-popup" href="#!" title="{!EMOTICONS_POPUP} {!LINK_NEW_WINDOW}"><img alt="{!EMOTICONS_POPUP}" width="16" height="16" src="{$IMG*,icons/32x32/editor/insert_emoticons}" /></a>
				{+END}
