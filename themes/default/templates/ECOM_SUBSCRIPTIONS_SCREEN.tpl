...
<p class="buttons-group">
	<a class="button-screen buttons--proceed" rel="add" href="{$PAGE_LINK*,_SEARCH:purchase:type_filter={$PRODUCT_SUBSCRIPTION}}"><span>{!START_NEW_SUBSCRIPTION} {+START,INCLUDE,ICON}NAME=buttons/proceed{+END}</span></a>
</p>
