...
<div aria-busy="true" class="spaced" id="loading_space" data-tpl="blockHelperDone" data-tpl-params="{+PARAMS_JSON,FIELD_NAME,COMCODE,COMCODE_SEMIHTML,SAVE_TO_ID,DELETE,PREFIX,sync_wysiwyg_attachments,TAG_CONTENTS}{_*}{+END}">
