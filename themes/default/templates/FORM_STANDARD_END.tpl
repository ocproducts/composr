...
<div data-require-javascript="core_form_interfaces" data-view="FormStandardEnd" data-view-params="{+START,PARAMS_JSON,preview_url,force_previews,FUNCTION,SECONDARY_FORM,SUPPORT_AUTOSAVE,FORM_NAME,SEPARATE_PREVIEW,BACK_URL}{_*}{+END}">
