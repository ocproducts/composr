...
DESCRIPTION={+START,IF_NON_EMPTY,{DESCRIPTION}}{DESCRIPTION}<br /><br />{+END}{!TREE_LIST_HELP,{$?,{_REQUIRED},{$?,{$IN_STR,{$USER_AGENT},Macintosh},{!TREE_LIST_HELP_DESELECT_MAC},{!TREE_LIST_HELP_DESELECT}}},{$?,{$EQ,{$PAGE},admin_sitemap,admin_permissions},{$?,{$IN_STR,{$USER_AGENT},Macintosh},{!TREE_LIST_HELP_MASS_EXPAND_MAC},{!TREE_LIST_HELP_MASS_EXPAND}}},{CONTENT_TYPE}}
RIGHT=1
{+END}
