...
<li data-tpl="themeScreenPreview">
	...
	{+START,IF_NON_EMPTY,{URL}}<a class="associated_link horiz-field-sep js-link-click-open-mobile-template-preview-window" title="{TEMPLATE*} {!LINK_NEW_WINDOW}" data-click-pd="1" href="{URL*}&amp;keep_wide_high=1&amp;keep_mobile=1" target="_blank"><span {+START,IF_NON_EMPTY,{COLOR}} style="color: {COLOR*}"{+END}>{!MOBILE_VERSION}</span></a>{+END}
