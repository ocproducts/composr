...
<script type="application/json" data-tpl-core-rich-media="mediaAudioWebsafe">
	{+START,PARAMS_JSON,player_id,player_width,player_height,LENGTH,URL,THUMB_URL,type,flashplayer,inline_stats}{_/}{+END}
</script>