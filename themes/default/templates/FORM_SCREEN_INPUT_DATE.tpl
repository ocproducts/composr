...
{+START,IF,{$EQ,{TYPE},datetime}}
	...
	<input name="{NAME*}_time" id="{NAME*}_time" type="time" size="5"{+START,IF_PASSED,TABINDEX} tabindex="{TABINDEX*}"{+END} value="{+START,IF_NON_EMPTY,{HOUR}}{$GET*,time_value}{+END}" class="form-control form-control-inline input-time{$?,{REQUIRED},-required}" data-tpl="formScreenInputDate" data-tpl-params="{+START,PARAMS_JSON,NAME}{_*}{+END}" />
{+END}
