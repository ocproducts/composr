...
<div id="{$GET*,wrapper_id}" class="box_wrapper" data-tpl="blockSideShoutbox" data-tpl-args="{+START,PARAMS_JSON,wrapper_id,block_call_url}{_*}{+END}">
	<section class="box box___block_side_shoutbox"><div class="box_inner">
		...
		<form title="{!SHOUTBOX}" onsubmit="if (check_field_for_blankness(this.elements['shoutbox_message'],event)) { $cms.ui.disableFormButtons(this); return true; } return false;" target="_self" action="{URL*}" method="post" autocomplete="off">
