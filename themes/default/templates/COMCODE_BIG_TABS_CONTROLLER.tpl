...
<div class="comcode_big_tab_controller" role="tablist" data-view="ComcodeBigTabsController" data-view-params="{+START,PARAMS_JSON,SWITCH_TIME,PASS_ID,big_tab_sets,TABS}{_*}{+END}">
	{+START,LOOP,TABS}
