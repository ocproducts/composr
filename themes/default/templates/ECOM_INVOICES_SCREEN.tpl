				...
				<td>
					...
					{+START,IF,{$HAS_ACTUAL_PAGE_ACCESS,admin_invoices}}
						<ul class="horizontal-links horiz-field-sep">
							<li><a class="btn btn-primary btn-scri admin--delete3" href="{$PAGE_LINK*,adminzone:admin_invoices:delete:{INVOICE_ID}}"><span>{+START,INCLUDE,ICON}NAME=admin/delete3{+END} {!DELETE}: #{INVOICE_ID}</span></a></li>
