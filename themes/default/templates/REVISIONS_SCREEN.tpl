...
<div data-tpl="revisionsScreen">
	...
	{+START,IF,{INCLUDE_FILTER_FORM}}
		...
		<div class="box_revisions_screen box"><div class="box-inner">
			<form title="{!PRIMARY_PAGE_FORM}" action="{$URL_FOR_GET_FORM*,{$SELF_URL,0,1}}" method="get" autocomplete="off">
				...
				<div class="revisions_filter_item_button">
					<input data-disable-on-click="1" accesskey="u" class="button_screen_item buttons--filter" type="submit" value="{!FILTER}" />
				</div>
			</form>
		</div></div>
	{+END}
