...
{+START,IF_NON_EMPTY,{$TRIM,{CONTENTS}}}
	...
	{+START,SET,tpl_marker_link}
		...
		<span onmouseover="activate_tooltip(this,event,'&lt;p&gt;{!TEMPLATES_WITH_EDIT_LINKS_PARAMETERS;^*}&lt;/p&gt;{PARAM_INFO;^*}','800px',null,null,null,true);" class="template_edit_link associated_link"><span onkeypress="window.open('{EDIT_URL;*}'); cancel_bubbling(event)" onclick="window.open('{EDIT_URL;*}'); cancel_bubbling(event);"><kbd>{CODENAME*}.tpl</kbd></span></span>
	{+END}
