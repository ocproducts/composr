...
<form class="cns_topic_poll_form" title="{!VOTE}" action="{VOTE_URL*}" method="post" data-tpl-cns-forum="cnsTopicPoll" data-tpl-args="{+START,PARAMS_JSON,MINIMUM_SELECTIONS,MAXIMUM_SELECTIONS}{_*}{+END}" autocomplete="off">
