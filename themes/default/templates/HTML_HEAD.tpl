...
<script {$CSP_NONCE_HTML} defer src="{$BASE_URL*}/data/polyfills/general.js"></script>
<script {$CSP_NONCE_HTML} defer src="{$BASE_URL*}/data/polyfills/url-search-params.max.js"></script>
<script {$CSP_NONCE_HTML} defer src="{$BASE_URL*}/data/polyfills/keyboardevent-key-polyfill.js"></script>
<script {$CSP_NONCE_HTML} defer src="{$BASE_URL*}/data/polyfills/fetch.js"></script>
<script {$CSP_NONCE_HTML} defer src="{$BASE_URL*}/data/polyfills/web-animations.min.js"></script>
<script {$CSP_NONCE_HTML} defer src="{$BASE_URL*}/data/polyfills/json5.js"></script>
