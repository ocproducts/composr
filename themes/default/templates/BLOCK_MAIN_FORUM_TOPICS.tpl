<section id="tray_{TITLE|}" data-toggleable-tray="{}" data-tray-cookie="{TITLE|}" class="box box___block_main_forum_topics">
	<h3 class="toggleable_tray_title js-tray-header">
		<a class="toggleable_tray_button" data-click-tray-toggle="tray_{TITLE|}" href="#!">
			<img alt="{!CONTRACT}: {$STRIP_TAGS,{TITLE}}" title="{!CONTRACT}" src="{$IMG*,1x/trays/contract2}" srcset="{$IMG*,2x/trays/contract2} 2x" />
		</a>
