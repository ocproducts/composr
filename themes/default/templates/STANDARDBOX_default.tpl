		...
		{+START,IF_IN_ARRAY,OPTIONS,tray_open,tray_closed}
			<h3 class="toggleable-tray-title js-tray-header">
				...
				{+START,IF_IN_ARRAY,OPTIONS,tray_closed}
					<a class="toggleable-tray-button js-tray-onclick-toggle-tray" href="#!"><img alt="{!EXPAND}: {$STRIP_TAGS,{TITLE}}" title="{!EXPAND}" width="24" height="24" src="{$IMG*,1x/trays/expand2}" /></a>
				{+END}
