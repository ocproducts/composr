<div class="calendar_day_entry">
	<div class="float_surrounder">
		...
		<a title="{TITLE*}{+START,IF,{$LT,{$LENGTH,{ID}},10}}: #{ID*}{+END}" href="{URL*}" class="calendar_day_entry_title">{+START,FRACTIONAL_EDITABLE,{TITLE},title,_SEARCH:cms_calendar:__edit:{ID}}{TITLE*}{+END}</a>
