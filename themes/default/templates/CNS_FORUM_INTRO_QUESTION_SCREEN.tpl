...
<form title="{!PROCEED}" action="{URL*}" method="post" autocomplete="off">
	...
	{+START,IF_NON_EMPTY,{ANSWER}}
		<div class="cns_intro_question_answer_box"><label for="answer">{!ANSWER}</label>: <input maxlength="255" id="answer" value="" type="text" name="answer" /> <input accesskey="u" data-disable-on-click="{}" class="button_screen buttons__proceed" type="submit" value="{!PROCEED}" /></div>
	{+END}
	{+START,IF_EMPTY,{ANSWER}}
		<div>
