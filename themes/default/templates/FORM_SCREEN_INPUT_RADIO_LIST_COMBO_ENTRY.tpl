<p data-tpl="formScreenInputRadioListComboEntry" data-tpl-params="{+START,PARAMS_JSON,NAME}{_*}{+END}">
	<label for="j_{NAME|*}_other">
		<input tabindex="{TABINDEX*}" class="input_radio" type="radio" id="j_{NAME|*}_other" name="{NAME*}" value=""{+START,IF_NON_EMPTY,{VALUE}} checked="checked"{+END} onchange="document.getElementById('j_{NAME|*}_other_custom').disabled=(!this.checked);" />
        {!OTHER}
    </label>
	<br />
