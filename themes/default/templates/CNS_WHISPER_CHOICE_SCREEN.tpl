				...
				<form title="{!PRIVATE_TOPIC}" action="{$URL_FOR_GET_FORM*,{URL}}" method="get" autocomplete="off">
					...
					<div>
						...
						<p class="proceed_button">
							<input class="button_screen buttons__new_topic" type="submit" data-disable-after-click="1" value="{!QUOTE_TO_PT}" />
						</p>
					</div>
				</form>
			</div></div>
		...
		<div class="box box___cns_whisper_choice_screen"><div class="box_inner">
			...
			<form title="{!PERSONAL_POST}" action="{$URL_FOR_GET_FORM*,{URL}}" method="get" autocomplete="off">
				...
				<div>
					...
					<p class="proceed_button">
						<input class="button_screen buttons__new_post_full" type="submit" data-disable-after-click="1" value="{!IN_TOPIC_PP}" />
					</p>
				</div>
			</form>
		</div></div>
