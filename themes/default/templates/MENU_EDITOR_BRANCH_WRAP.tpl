...
<div class="menu-editor-branch" id="branch-wrap-{I*}" data-tpl="menuEditorBranchWrap" data-tpl-params="{+START,PARAMS_JSON,CLICKABLE_SECTIONS,BRANCH_TYPE,I}{_*}{+END}">
	<div class="menu-editor-branch-inner" id="branch-{I*}">
		...
		<input maxlength="255" class="form-control form-control-inline js-focus-make-caption-field-selected js-dblclick-scroll-to-heading"type="text" value="{CAPTION*}" id="caption_{I*}" name="caption_{I*}" />
		...
		<select style="display: none" class="form-control form-control-inline js-click-menu-editor-branch-type-change js-change-menu-editor-branch-type-change" title="{$STRIP_TAGS,{!MENU_ENTRY_BRANCH}}" id="branch_type_{I*}" name="branch_type_{I*}">
