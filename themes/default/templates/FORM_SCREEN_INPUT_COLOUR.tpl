...
{+START,IF,{RAW_FIELD}}
	<div class="float_surrounder" data-tpl="formScreenInputColour" data-tpl-args="{+START,PARAMS_JSON,RAW_FIELD,NAME,DEFAULT,TABINDEX,PRETTY_NAME,_REQUIRED}{_*}{+END}">
...
{+START,IF,{$NOT,{RAW_FIELD}}}
	<tr class="field_input" data-tpl="formScreenInputColour" data-tpl-args="{+START,PARAMS_JSON,RAW_FIELD,NAME,DEFAULT,TABINDEX,PRETTY_NAME,_REQUIRED}{_*}{+END}">
