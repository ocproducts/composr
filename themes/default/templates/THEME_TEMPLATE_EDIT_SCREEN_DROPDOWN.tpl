<div class="float_surrounder {$CYCLE,tep,tpl_dropdown_row_a,tpl_dropdown_row_b}">
	...
	{+START,IF,{$JS_ON}}
		<div class="right">
			<input class="button_micro menu___generic_admin__add_one" name="f{ID*}dd_{NAME*}" onclick="return template_insert_parameter('f{ID;*}{NAME;*}','{ID;*}');" type="button" value="{LANG*}" />
		</div>
	{+END}
</div>
