	...
	<div class="gallery-box-details">
		...
		<div class="buttons-group">
			<div class="buttons-group-inner">
				...
				<a class="btn btn-secondary buttons--slideshow" rel="nofollow"{+START,IF,{$NOT,{$MOBILE}}} target="_blank"{+END} href="{SLIDESHOW_URL*}"><span>{+START,INCLUDE,ICON}NAME=buttons/slideshow{+END} {!_SLIDESHOW}</span></a>
				{+END}{+END}
			</div>
		</div>
	</div>
