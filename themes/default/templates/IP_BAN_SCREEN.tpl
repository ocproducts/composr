...
<form title="{!PRIMARY_PAGE_FORM}" action="{URL*}" method="post" autocomplete="off">
	...
	<div class="constrain_field">
		<textarea cols="30" rows="14" class="wide_field textarea_scroll" id="bans" name="bans" data-cms-call="manage_scroll_height" {+START,IF,{$NOT,{$MOBILE}}} onkeyup="manage_scroll_height(this);"{+END}>{BANS*}</textarea>
	</div>
