<div class="gallery-mode-screen gallery-grid-mode-screen" data-tpl="galleryGridModeScreen" itemscope="itemscope" itemtype="http://schema.org/ImageGallery">
	...
	{+START,IF_NON_EMPTY,{ENTRIES}}
		<div class="gallery-actions">
			<a class="btn btn-primary btn-slideshow js-set-href-to-slideshow-url" rel="nofollow"{+START,IF,{$NOT,{$MOBILE}}} target="_blank" title="{!SLIDESHOW} {!LINK_NEW_WINDOW}"{+END} href="#!" style="display: none;">{+START,INCLUDE,ICON}NAME=buttons/slideshow{+END} {!_SLIDESHOW}</a>
