...
<section class="box box___block_main_newsletter_signup"><div class="box_inner">
	...
	<form title="{!NEWSLETTER}" onsubmit="if ((check_field_for_blankness(this.elements['address{NID;*}'],event)) &amp;&amp; (this.elements['address{NID*}'].value.match(/^[a-zA-Z0-9\._\-\+]+@[a-zA-Z0-9\._\-]+$/))) { disable_button_just_clicked(this); return true; } window.fauxmodal_alert('{!javascript:NOT_A_EMAIL;=*}'); return false;" action="{URL*}" method="post" autocomplete="off">
