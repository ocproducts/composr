...
<form action="{$SELF_URL*}" method="post" title="{!PRIMARY_PAGE_FORM}" autocomplete="off">
	...
	<div>
		...
		<select name="sections_to_run[]" id="sections_to_run" multiple="multiple" size="30" class="wide-field" data-submit-on-enter="1">
			{SECTIONS}
		</select>
	</div>
	...
	<p class="proceed-button">
		<button class="button-screen buttons--proceed" type="submit">{+START,INCLUDE,ICON}NAME=buttons/proceed{+END} {!HEALTH_CHECK}</button>
	</p>
</form>
