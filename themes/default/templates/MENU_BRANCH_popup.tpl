...
<li data-view="PopupMenuBranch" data-view-params="{+START,PARAMS_JSON,MENU,RAND,HAS_CHILDREN}{_*}{+END}" class="{$?,{CURRENT},current,non-current} {$?,{$IS_EMPTY,{IMG}},has_no_img,has-img} {$?,{$GET,HAS_CHILDREN},js-mousemove-pop-up-menu}">
