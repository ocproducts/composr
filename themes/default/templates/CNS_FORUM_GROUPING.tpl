<div class="cns_forum_grouping" data-toggleable-tray="{}">
	<h3 class="toggleable_tray_title_heading js-tray-header">
		<span class="cns_forum_grouping_toggleable_tray_button">
			<a class="toggleable_tray_button js-tray-onclick-toggle-tray" href="#!"><img title="{!TOGGLE_GROUPING_VISIBILITY}" alt="{!TOGGLE_GROUPING_VISIBILITY}" src="{$IMG*,1x/trays/{EXPAND_TYPE*}2}" srcset="{$IMG*,2x/trays/{EXPAND_TYPE*}2} 2x" /></a>
		</span>
