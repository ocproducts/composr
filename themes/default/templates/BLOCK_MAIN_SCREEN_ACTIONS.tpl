<aside class="screen_actions_outer box" data-tpl="blockMainScreenActions" data-tpl-params="{+START,PARAMS_JSON,EASY_SELF_URL}{_*}{+END}"><nav class="screen_actions box-inner">
	...
	<div class="stumbleupon"><a class="link_exempt js-click-add-to-stumbleupon" target="_blank" title="{!ADD_TO_STUMBLEUPON} {!LINK_NEW_WINDOW}" href="http://www.stumbleupon.com/submit?url={EASY_SELF_URL*}"><span>{!ADD_TO_STUMBLEUPON}</span></a></div>
	<div class="digg"><a class="link_exempt js-click-add-to-digg" target="_blank" title="{!ADD_TO_DIGG} {!LINK_NEW_WINDOW}" href="http://digg.com/submit?phase=2&amp;url={EASY_SELF_URL*}"><span>{!ADD_TO_DIGG}</span></a></div>
