<aside class="screen_actions_outer box"><nav class="screen_actions box_inner">
	...
	{+START,IF,{$BROWSER_MATCHES,ie}}
		<div class="favorites"><a class="link_exempt" title="{!ADD_TO_FAVORITES}" href="#!" onclick="window.external.AddFavorite(window.location.href,document.title);"><span>{!ADD_TO_FAVORITES}</span></a></div>
	{+END}
