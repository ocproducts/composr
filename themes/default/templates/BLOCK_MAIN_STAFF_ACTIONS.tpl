...
<section id="tray_{!MODULE_TRANS_NAME_admin_actionlog|}" data-toggleable-tray="{ cookie: '{MODULE_TRANS_NAME_admin_actionlog|}' }" data-tpl="blockMainStaffActions" data-tpl-params="{+START,PARAMS_JSON,ajax_block_main_staff_actions_wrapper,block_call_url}{_*}{+END}" class="box box___block_main_staff_actions">
