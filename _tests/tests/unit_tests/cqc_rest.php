...
class cqc_rest_test_set extends cms_test_case
{
    public function testRest()
    {
        ...
        $result = http_download_file(get_base_url() . '/_tests/codechecker/code_quality.php?avoid=sources,site,adminzone,cms,forum,pages,data_custom&api=1', null, true, false, 'Composr', null, array(), null, null, null, null, null, null, 10000.0);
