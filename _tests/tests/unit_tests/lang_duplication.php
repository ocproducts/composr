...
class lang_duplication_test_set extends cms_test_case
{
    ...
    public function testLangDuplication()
    {
        ...
        $this->assertTrue($percentage_duplicated < 8.5, 'Overall heavy duplication'); // Ideally we'd lower it, but 6% is what it was when this test was written. We're testing it's not getting worse.
