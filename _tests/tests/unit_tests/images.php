...
class images_test_set extends cms_test_case
{
        ...
        foreach ($file_types as $extension) {
            foreach ($file_aspects as $width => $height) {
                ...
                if ($this->isRunningTest('1')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 2, $height * 2, null, false, $width * 2, $height * 2, $additional_information), 'Double width and height of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('2')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 2, $height * 3, null, false, $width * 2, $height * 2, $additional_information), 'Double width, 3x height of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('3')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 3, $height * 2, null, false, $width * 2, $height * 2, $additional_information), 'Double height, 3x width of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('4')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width, $height, null, false, $width, $height, $additional_information), 'Keep the same width and height of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('5')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 2, null, null, false, $width * 2, $height * 2, $additional_information), 'Double width, ignore (null) height of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('6')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, $height * 2, null, false, $width * 2, $height * 2, $additional_information), 'Double height, ignore (null) width of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('7')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, null, 32, false, (($width > $height) ? 32 : null), (($height > $width) ? 32 : null), $additional_information), 'Use box width 16 of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('8')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, null, 8, false, (($width > $height) ? 8 : null), (($height > $width) ? 8 : null), $additional_information), 'Use box width 4 of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('9')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, null, 2, false, (($width > $height) ? 2 : null), (($height > $width) ? 2 : null), $additional_information), 'Use box width 1 of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('10')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 2, $height * 2, null, true, $width, $height, $additional_information), 'Double width and height with only make smaller = true of ' . strval($width) . 'x' . strval($height) . '.' . $extension . '. ' . $additional_information);
                }

                // Shrink tests
                if ($this->isRunningTest('11')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width, $height, null, false, $width, $height, $additional_information), 'Half the width and height of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('12')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width, $height * 2, null, false, $width, $height, $additional_information), 'Half width, keep height of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('13')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 2, $height, null, false, $width, $height, $additional_information), 'Half height, keep width of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('14')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width * 2, $height * 2, null, false, $width * 2, $height * 2, $additional_information), 'Keep the same width and height of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('15')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width, null, null, false, $width, null, $additional_information), 'Half the width, ignore height of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('16')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, $height, null, false, null, $height, $additional_information), 'Half the height, ignore width of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('17')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, null, 16, false, (($width > $height) ? 16 : null), (($height > $width) ? 16 : null), $additional_information), 'Use box width 16 of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('18')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, null, 4, false, (($width > $height) ? 4 : null), (($height > $width) ? 4 : null), $additional_information), 'Use box width 4 of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('19')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, null, null, 1, false, (($width > $height) ? 1 : null), (($height > $width) ? 1 : null), $additional_information), 'Use box width 1 of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
                if ($this->isRunningTest('20')) {
                    $this->assertTrue($this->runDimensionTest(get_file_base() . '/_tests/assets/images/' . strval($width) . 'x' . strval($height) . '.' . $extension, $width, $height, null, true, $width, $height, $additional_information), 'Half the width and height with only make smaller = true of ' . strval($width * 2) . 'x' . strval($height * 2) . '.' . $extension . '. ' . $additional_information);
                }
            }
    ...
    protected function outputDebugVisual($file_path)
    {
    ...
    protected function runQuadrantTest($file, $convert_width, $convert_height, &$additional_information)
    {
        ...
        if (!$this->checkColor($file, $path, $image_resource, intval($dimensions[0] / 4), intval($dimensions[1] / 4), 255, 0, 0, 0, 60, $additional_information)) {
            return false;
        }

        // Test green quadrant in upper right corner
        if (!$this->checkColor($file, $path, $image_resource, intval($dimensions[0] * 0.75), intval($dimensions[1] / 4), 0, 255, 0, 0, 60, $additional_information)) {
            return false;
        }

        // Test blue quadrant in lower left corner
        if (!$this->checkColor($file, $path, $image_resource, intval($dimensions[0] / 4), intval($dimensions[1] * 0.75), 0, 0, 255, 0, 60, $additional_information)) {
            return false;
        }

        // Test white quadrant in lower right corner
        if (!$this->checkColor($file, $path, $image_resource, intval($dimensions[0] * 0.75), intval($dimensions[1] * 0.75), 255, 255, 255, 0, 60, $additional_information)) {
            return false;
        }
