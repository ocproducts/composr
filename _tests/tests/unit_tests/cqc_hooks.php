...
class cqc_hooks_test_set extends cms_test_case
{
    public function testHooks()
    {
        ...
        $result = http_download_file(get_base_url() . '/_tests/codechecker/code_quality.php?subdir=sources/hooks&api=1', null, true, false, 'Composr', null, array(), null, null, null, null, null, null, 10000.0);
