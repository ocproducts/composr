...
class forum_test_set extends cms_test_case
{
    ...
    public function setUp()
    {
        ...
        $this->forum_id = cns_make_forum('TestAdd', 'Test', db_get_first_id(), $this->access_mapping, db_get_first_id(), 1, 1, 0, '', '', '', 'last_post', 0, 0, '', '', '', null, '', '', '', 'post_as_guest');
    ...
    {
        cns_edit_forum($this->forum_id, 'TestEdit', 'Test', db_get_first_id(), db_get_first_id(), 1, 1, 0, '', '', '', 'last_post', 0, 0, '', '', '', null, '', '', '', 'post_as_guest', false);
