        ...
        foreach ($paths as $_path => $_ext) {
            ...
            foreach ($files as $path) {
                ...
                if ($ext == 'js' || $ext == 'css' || $ext == 'php') {
                    if (preg_match('#^sources_custom/(getid3|geshi|photobucket|spout|sabredav|composr_mobile_sdk/ios|Swift-4.1.1|ILess|locations|facebook|programe|php-crossword)/#', $path) != 0) {
                        continue;
                    }
