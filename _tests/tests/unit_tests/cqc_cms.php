 ...
 */
class cqc_cms_test_set extends cms_test_case
{
    public function testCMS()
    {
        ...
        $result = http_download_file(get_base_url() . '/_tests/codechecker/code_quality.php?subdir=cms&api=1', null, true, false, 'Composr', null, array(), null, null, null, null, null, null, 10000.0);
