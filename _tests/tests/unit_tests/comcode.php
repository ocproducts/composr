...
';
        ...
        $comcode = '
<input class="cms-keep-ui-controlled" readonly="readonly" size="45" style="cursor: pointer;" title="[contents][/contents]" type="button" value="contents Comcode tag (dbl-click to edit/delete)" />
