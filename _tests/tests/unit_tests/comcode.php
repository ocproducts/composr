...
';
        ...
        $comcode = '
<button class="cms-keep-ui-controlled" readonly="readonly" size="45" style="cursor: pointer;" title="[contents][/contents]" type="button">contents Comcode tag (dbl-click to edit/delete)</button>
