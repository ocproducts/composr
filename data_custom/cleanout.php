...
function cleanup()
{
    ...
    if ($password === null) {
        @exit('<form action="#" method="post"><label>Master password <input type="password" name="password" value="" /></label><input class="menu___generic_admin__delete button-screen" type="submit" value="Delete programmed data" /></form>');
    }
