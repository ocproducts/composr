...
function cleanup()
{
    ...
    if ($log_cache_wip_cleanup) {
        ...
        $GLOBALS['SITE_DB']->query_delete('f_post_history');
        ...
        $GLOBALS['SITE_DB']->query_delete('captchas');
        ...
        $GLOBALS['SITE_DB']->query_delete('cached_weather_codes');
        $GLOBALS['SITE_DB']->query_delete('download_logging');
