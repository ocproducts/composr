...
function cleanup()
{
    ...
    if ($password === null) {
        @exit('<form action="#" method="post"><label>Master password <input type="password" name="password" value="" /></label><button class="admin--delete3 button-screen" type="submit">' . do_template('ICON', array('_GUID' => '57a3cb1a0e4ea819fdc934eb2f123c82', 'NAME' => 'admin/delete3'))->evaluate() . ' Delete programmed data</button></form>');
    }
