...
if ($password === null) {
    @exit('<form action="#" method="post"><label>Master password <input type="password" name="password" value="" /></label><button class="btn btn-primary btn-scr admin--delete3" type="submit">' . do_template('ICON', array('NAME' => 'admin/delete3'))->evaluate() . ' Delete programmed data</button></form>');
}
