...
class Module_report_content
{
    ...
    public function actualiser()
    {
        ...
        $post_id = cns_make_post($topic_id, $content_title, $post, 0, $new_topic, 1, 0, null, null, null, null, null, null, null, false, true, $forum_id, true, $topic_title, null, $anonymous == 1);
