...
class Module_sites
{
    ...
    public function hostingcopy_step1()
    {
        ...
        $hostingcopy_form = do_template('FORM_SCREEN', array('_GUID' => '32928b56f4f4b0e7d7e835673dc5aff8', 'TITLE' => $this->title, '_GUID' => 'e9f51de85f7cf800aa3097366a03ca5e', 'HIDDEN' => '', 'URL' => $post_url, 'FIELDS' => $fields, 'TEXT' => do_lang_tempcode('CMS_COPYWAIT'), 'SUBMIT_ICON' => 'buttons__proceed', 'SUBMIT_NAME' => $submit_name));
    }
