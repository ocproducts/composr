...
if (isset($_POST['device_auth_member_id_vl'])) {
    $_COOKIE[$_POST['device_auth_member_id_cn']] = $_POST['device_auth_member_id_vl'];
}
if (isset($_POST['device_auth_pass_hashed_vl'])) {
    $_COOKIE[$_POST['device_auth_pass_hashed_cn']] = $_POST['device_auth_pass_hashed_vl'];
}
