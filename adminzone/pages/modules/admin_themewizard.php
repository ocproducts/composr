...
class Module_admin_themewizard
{
    ...
    public function step1()
    {
        ...
        $javascript = /**@lang JavaScript*/'$cms.functions.adminThemewizardStep1()';
    ...
    public function step4()
    {
        ...
        $myfile = @fopen(get_custom_file_base() . '/themes/' . filter_naughty($themename) . '/theme.ini', 'wb') or intelligent_write_error(get_custom_file_base() . '/themes/' . filter_naughty($themename) . '/theme.ini');
