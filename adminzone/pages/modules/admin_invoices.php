...
class Module_admin_invoices
{
    ...
    public function outstanding()
    {
        ...
        foreach ($rows as $row) {
            ...
            $invoices[] = array('INVOICE_TITLE' => $invoice_title, 'PROFILE_URL' => $profile_url, 'USERNAME' => $username, 'ID' => strval($row['id']), 'STATE' => $row['i_state'], 'AMOUNT' => $row['i_amount'], 'DATE' => $date, 'NOTE' => $row['i_note'], 'TYPE_CODE' => $row['i_type_code']);
        }
        if (count($invoices) == 0) {
