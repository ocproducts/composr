...
if ($facebook_appid == '') {
    $config_url = build_url(array('page' => 'admin_config', 'type' => 'category', 'id' => 'COMPOSR_APIS', 'redirect' => get_self_url(true)), get_module_zone('admin_config'), array(), false, false, false, 'group_FACEBOOK_SYNDICATION');
