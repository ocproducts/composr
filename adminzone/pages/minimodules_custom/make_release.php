...
function phase_2()
{
    ...
    echo '
        ...
        <li>
            <strong>Test</strong>: Go to <a href="http://compo.sr/download.htm">Composr download page</a> to ensure the right packages are there and no error messages display.
        </li>
    ';
