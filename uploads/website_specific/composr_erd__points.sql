		...
		CREATE TABLE cms10_leader_board
		(
		...
		CREATE INDEX `chargelog.member_id` ON cms10_chargelog(member_id);
		ALTER TABLE cms10_chargelog ADD FOREIGN KEY `chargelog.member_id` (member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `chargelog.reason` ON cms10_chargelog(reason);
		ALTER TABLE cms10_chargelog ADD FOREIGN KEY `chargelog.reason` (reason) REFERENCES cms10_translate (id);
		...
		CREATE INDEX `leader_board.lb_member` ON cms10_leader_board(lb_member);
		ALTER TABLE cms10_leader_board ADD FOREIGN KEY `leader_board.lb_member` (lb_member) REFERENCES cms10_f_members (id);
