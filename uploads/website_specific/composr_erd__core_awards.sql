		CREATE TABLE cms4_award_archive
		(
		...
		CREATE INDEX `award_archive.a_type_id` ON cms4_award_archive(a_type_id);
		ALTER TABLE cms4_award_archive ADD FOREIGN KEY `award_archive.a_type_id` (a_type_id) REFERENCES cms4_award_types (id);

		CREATE INDEX `award_archive.member_id` ON cms4_award_archive(member_id);
		ALTER TABLE cms4_award_archive ADD FOREIGN KEY `award_archive.member_id` (member_id) REFERENCES cms4_f_members (id);

		CREATE INDEX `award_types.a_description` ON cms4_award_types(a_description);
		ALTER TABLE cms4_award_types ADD FOREIGN KEY `award_types.a_description` (a_description) REFERENCES cms4_translate (id);

		CREATE INDEX `award_types.a_title` ON cms4_award_types(a_title);
		ALTER TABLE cms4_award_types ADD FOREIGN KEY `award_types.a_title` (a_title) REFERENCES cms4_translate (id);
