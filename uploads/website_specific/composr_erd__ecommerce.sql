		CREATE TABLE cms10_trans_expecting
		(
			id varchar(80) NULL,
		...
		CREATE TABLE cms10_subscriptions
		(
		...
		CREATE TABLE cms10_f_usergroup_subs
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `trans_expecting.e_member_id` ON cms10_trans_expecting(e_member_id);
		ALTER TABLE cms10_trans_expecting ADD FOREIGN KEY `trans_expecting.e_member_id` (e_member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `subscriptions.s_member_id` ON cms10_subscriptions(s_member_id);
		ALTER TABLE cms10_subscriptions ADD FOREIGN KEY `subscriptions.s_member_id` (s_member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `f_usergroup_subs.s_title` ON cms10_f_usergroup_subs(s_title);
		ALTER TABLE cms10_f_usergroup_subs ADD FOREIGN KEY `f_usergroup_subs.s_title` (s_title) REFERENCES cms10_translate (id);

		CREATE INDEX `f_usergroup_subs.s_description` ON cms10_f_usergroup_subs(s_description);
		ALTER TABLE cms10_f_usergroup_subs ADD FOREIGN KEY `f_usergroup_subs.s_description` (s_description) REFERENCES cms10_translate (id);

		CREATE INDEX `f_usergroup_subs.s_group_id` ON cms10_f_usergroup_subs(s_group_id);
		ALTER TABLE cms10_f_usergroup_subs ADD FOREIGN KEY `f_usergroup_subs.s_group_id` (s_group_id) REFERENCES cms10_f_groups (id);

		CREATE INDEX `f_usergroup_subs.s_mail_start` ON cms10_f_usergroup_subs(s_mail_start);
		ALTER TABLE cms10_f_usergroup_subs ADD FOREIGN KEY `f_usergroup_subs.s_mail_start` (s_mail_start) REFERENCES cms10_translate (id);

		CREATE INDEX `f_usergroup_subs.s_mail_end` ON cms10_f_usergroup_subs(s_mail_end);
		ALTER TABLE cms10_f_usergroup_subs ADD FOREIGN KEY `f_usergroup_subs.s_mail_end` (s_mail_end) REFERENCES cms10_translate (id);

		CREATE INDEX `f_usergroup_subs.s_mail_uhoh` ON cms10_f_usergroup_subs(s_mail_uhoh);
		ALTER TABLE cms10_f_usergroup_subs ADD FOREIGN KEY `f_usergroup_subs.s_mail_uhoh` (s_mail_uhoh) REFERENCES cms10_translate (id);

		CREATE INDEX `invoices.i_member_id` ON cms10_invoices(i_member_id);
		ALTER TABLE cms10_invoices ADD FOREIGN KEY `invoices.i_member_id` (i_member_id) REFERENCES cms10_f_members (id);
