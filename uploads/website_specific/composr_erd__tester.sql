		CREATE TABLE cms10_test_sections
		(
		...
		CREATE INDEX `test_sections.s_assigned_to` ON cms10_test_sections(s_assigned_to);
		ALTER TABLE cms10_test_sections ADD FOREIGN KEY `test_sections.s_assigned_to` (s_assigned_to) REFERENCES cms10_f_members (id);

		CREATE INDEX `tests.t_section` ON cms10_tests(t_section);
		ALTER TABLE cms10_tests ADD FOREIGN KEY `tests.t_section` (t_section) REFERENCES cms10_test_sections (id);

		CREATE INDEX `tests.t_assigned_to` ON cms10_tests(t_assigned_to);
		ALTER TABLE cms10_tests ADD FOREIGN KEY `tests.t_assigned_to` (t_assigned_to) REFERENCES cms10_f_members (id);

		CREATE INDEX `tests.t_inherit_section` ON cms10_tests(t_inherit_section);
		ALTER TABLE cms10_tests ADD FOREIGN KEY `tests.t_inherit_section` (t_inherit_section) REFERENCES cms10_test_sections (id);
