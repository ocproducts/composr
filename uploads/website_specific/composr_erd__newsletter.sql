		...
		CREATE TABLE cms10_newsletter_archive
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE cms10_newsletter_subscribe
		(
		...
		CREATE TABLE cms10_newsletter_drip_send
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE cms10_newsletter_periodic
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `newsletter_subscribe.newsletter_id` ON cms10_newsletter_subscribe(newsletter_id);
		ALTER TABLE cms10_newsletter_subscribe ADD FOREIGN KEY `newsletter_subscribe.newsletter_id` (newsletter_id) REFERENCES cms10_newsletters (id);
