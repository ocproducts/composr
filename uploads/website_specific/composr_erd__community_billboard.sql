		CREATE TABLE cms10_community_billboard
		(
		...
		CREATE INDEX `community_billboard.the_message` ON cms10_community_billboard(the_message);
		ALTER TABLE cms10_community_billboard ADD FOREIGN KEY `community_billboard.the_message` (the_message) REFERENCES cms10_translate (id);

		CREATE INDEX `community_billboard.member_id` ON cms10_community_billboard(member_id);
		ALTER TABLE cms10_community_billboard ADD FOREIGN KEY `community_billboard.member_id` (member_id) REFERENCES cms10_f_members (id);
