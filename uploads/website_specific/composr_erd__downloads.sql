		CREATE TABLE cms10_download_categories
		(
		...
		CREATE TABLE cms10_download_downloads
		(
		...
		CREATE TABLE cms10_download_logging
		(
			id integer NULL,
		...
		CREATE TABLE cms10_download_licences
		(
		...
		CREATE INDEX `download_categories.category` ON cms10_download_categories(category);
		ALTER TABLE cms10_download_categories ADD FOREIGN KEY `download_categories.category` (category) REFERENCES cms10_translate (id);

		CREATE INDEX `download_categories.parent_id` ON cms10_download_categories(parent_id);
		ALTER TABLE cms10_download_categories ADD FOREIGN KEY `download_categories.parent_id` (parent_id) REFERENCES cms10_download_categories (id);

		CREATE INDEX `download_categories.description` ON cms10_download_categories(description);
		ALTER TABLE cms10_download_categories ADD FOREIGN KEY `download_categories.description` (description) REFERENCES cms10_translate (id);

		CREATE INDEX `download_downloads.submitter` ON cms10_download_downloads(submitter);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.submitter` (submitter) REFERENCES cms10_f_members (id);

		CREATE INDEX `download_downloads.download_licence` ON cms10_download_downloads(download_licence);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.download_licence` (download_licence) REFERENCES cms10_download_licences (id);

		CREATE INDEX `download_downloads.description` ON cms10_download_downloads(description);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.description` (description) REFERENCES cms10_translate (id);

		CREATE INDEX `download_downloads.author` ON cms10_download_downloads(author);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.author` (author) REFERENCES cms10_authors (author);

		CREATE INDEX `download_downloads.additional_details` ON cms10_download_downloads(additional_details);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.additional_details` (additional_details) REFERENCES cms10_translate (id);

		CREATE INDEX `download_downloads.out_mode_id` ON cms10_download_downloads(out_mode_id);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.out_mode_id` (out_mode_id) REFERENCES cms10_download_downloads (id);

		CREATE INDEX `download_downloads.name` ON cms10_download_downloads(name);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.name` (name) REFERENCES cms10_translate (id);

		CREATE INDEX `download_downloads.category_id` ON cms10_download_downloads(category_id);
		ALTER TABLE cms10_download_downloads ADD FOREIGN KEY `download_downloads.category_id` (category_id) REFERENCES cms10_download_categories (id);

		CREATE INDEX `download_logging.id` ON cms10_download_logging(id);
		ALTER TABLE cms10_download_logging ADD FOREIGN KEY `download_logging.id` (id) REFERENCES cms10_download_downloads (id);

		CREATE INDEX `download_logging.member_id` ON cms10_download_logging(member_id);
		ALTER TABLE cms10_download_logging ADD FOREIGN KEY `download_logging.member_id` (member_id) REFERENCES cms10_f_members (id);
