		...
		CREATE INDEX `bookmarks.b_owner` ON cms10_bookmarks(b_owner);
		ALTER TABLE cms10_bookmarks ADD FOREIGN KEY `bookmarks.b_owner` (b_owner) REFERENCES cms10_f_members (id);
