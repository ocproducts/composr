		CREATE TABLE cms10_workflow_permissions
		(
		...
		CREATE TABLE cms10_workflow_requirements
		(
		...
		CREATE TABLE cms10_workflow_content
		(
		...
		CREATE TABLE cms10_workflow_content_status
		(
		...
		CREATE INDEX `workflow_permissions.workflow_approval_name` ON cms10_workflow_permissions(workflow_approval_name);
		ALTER TABLE cms10_workflow_permissions ADD FOREIGN KEY `workflow_permissions.workflow_approval_name` (workflow_approval_name) REFERENCES cms10_translate (id);

		CREATE INDEX `workflow_permissions.usergroup` ON cms10_workflow_permissions(usergroup);
		ALTER TABLE cms10_workflow_permissions ADD FOREIGN KEY `workflow_permissions.usergroup` (usergroup) REFERENCES cms10_f_groups (id);

		CREATE INDEX `workflow_requirements.workflow_name` ON cms10_workflow_requirements(workflow_name);
		ALTER TABLE cms10_workflow_requirements ADD FOREIGN KEY `workflow_requirements.workflow_name` (workflow_name) REFERENCES cms10_translate (id);

		CREATE INDEX `workflow_requirements.workflow_approval_name` ON cms10_workflow_requirements(workflow_approval_name);
		ALTER TABLE cms10_workflow_requirements ADD FOREIGN KEY `workflow_requirements.workflow_approval_name` (workflow_approval_name) REFERENCES cms10_translate (id);

		CREATE INDEX `workflow_content.original_submitter` ON cms10_workflow_content(original_submitter);
		ALTER TABLE cms10_workflow_content ADD FOREIGN KEY `workflow_content.original_submitter` (original_submitter) REFERENCES cms10_f_members (id);

		CREATE INDEX `workflow_content.workflow_name` ON cms10_workflow_content(workflow_name);
		ALTER TABLE cms10_workflow_content ADD FOREIGN KEY `workflow_content.workflow_name` (workflow_name) REFERENCES cms10_translate (id);

		CREATE INDEX `workflow_content_status.workflow_approval_name` ON cms10_workflow_content_status(workflow_approval_name);
		ALTER TABLE cms10_workflow_content_status ADD FOREIGN KEY `workflow_content_status.workflow_approval_name` (workflow_approval_name) REFERENCES cms10_translate (id);

		CREATE INDEX `workflow_content_status.approved_by` ON cms10_workflow_content_status(approved_by);
		ALTER TABLE cms10_workflow_content_status ADD FOREIGN KEY `workflow_content_status.approved_by` (approved_by) REFERENCES cms10_f_members (id);
