		CREATE TABLE cms4_comcode_pages
		(
		...
		CREATE TABLE cms4_cached_comcode_pages
		(
		...
		CREATE INDEX `comcode_pages.p_submitter` ON cms4_comcode_pages(p_submitter);
		ALTER TABLE cms4_comcode_pages ADD FOREIGN KEY `comcode_pages.p_submitter` (p_submitter) REFERENCES cms4_f_members (id);

		CREATE INDEX `cached_comcode_pages.cc_page_title` ON cms4_cached_comcode_pages(cc_page_title);
		ALTER TABLE cms4_cached_comcode_pages ADD FOREIGN KEY `cached_comcode_pages.cc_page_title` (cc_page_title) REFERENCES cms4_translate (id);

		CREATE INDEX `cached_comcode_pages.string_index` ON cms4_cached_comcode_pages(string_index);
		ALTER TABLE cms4_cached_comcode_pages ADD FOREIGN KEY `cached_comcode_pages.string_index` (string_index) REFERENCES cms4_translate (id);

		CREATE INDEX `cached_comcode_pages.the_zone` ON cms4_cached_comcode_pages(the_zone);
		ALTER TABLE cms4_cached_comcode_pages ADD FOREIGN KEY `cached_comcode_pages.the_zone` (the_zone) REFERENCES cms4_zones (zone_name);
