		...
		CREATE TABLE cms10_staff_tips_dismissed
		(
		...
		CREATE TABLE cms10_sitewatchlist
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `adminlogs.member_id` ON cms10_adminlogs(member_id);
		ALTER TABLE cms10_adminlogs ADD FOREIGN KEY `adminlogs.member_id` (member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `staff_tips_dismissed.t_member` ON cms10_staff_tips_dismissed(t_member);
		ALTER TABLE cms10_staff_tips_dismissed ADD FOREIGN KEY `staff_tips_dismissed.t_member` (t_member) REFERENCES cms10_f_members (id);
