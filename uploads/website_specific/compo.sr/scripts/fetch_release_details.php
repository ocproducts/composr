...
if ((array_key_exists(0, $news_rows)) && (has_category_access($GLOBALS['FORUM_DRIVER']->get_guest_id(), 'news', $news_rows[0]['news_category']))) {
    ...
    $news_html = preg_replace('#<a class="hide_button" href="\#!" onclick="hideTag\(this\.parentNode\.parentNode\); return false;"><img alt="Expand" title="Expand" src="' . escape_html(find_theme_image('1x/trays/expand')) . '" /></a>#', '', $news_html);
