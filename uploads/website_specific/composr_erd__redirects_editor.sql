		...
		CREATE INDEX `redirects.r_from_zone` ON cms10_redirects(r_from_zone);
		ALTER TABLE cms10_redirects ADD FOREIGN KEY `redirects.r_from_zone` (r_from_zone) REFERENCES cms10_zones (zone_name);

		CREATE INDEX `redirects.r_to_zone` ON cms10_redirects(r_to_zone);
		ALTER TABLE cms10_redirects ADD FOREIGN KEY `redirects.r_to_zone` (r_to_zone) REFERENCES cms10_zones (zone_name);
