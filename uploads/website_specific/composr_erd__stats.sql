		...
		CREATE TABLE cms10_usersonline_track
		(
		...
		CREATE INDEX `stats.member_id` ON cms10_stats(member_id);
		ALTER TABLE cms10_stats ADD FOREIGN KEY `stats.member_id` (member_id) REFERENCES cms10_f_members (id);
