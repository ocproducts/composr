		...
		CREATE INDEX `iotd.i_title` ON cms10_iotd(i_title);
		ALTER TABLE cms10_iotd ADD FOREIGN KEY `iotd.i_title` (i_title) REFERENCES cms10_translate (id);

		CREATE INDEX `iotd.caption` ON cms10_iotd(caption);
		ALTER TABLE cms10_iotd ADD FOREIGN KEY `iotd.caption` (caption) REFERENCES cms10_translate (id);

		CREATE INDEX `iotd.submitter` ON cms10_iotd(submitter);
		ALTER TABLE cms10_iotd ADD FOREIGN KEY `iotd.submitter` (submitter) REFERENCES cms10_f_members (id);
