		CREATE TABLE cms10_credit_purchases
		(
		...
		CREATE INDEX `credit_purchases.member_id` ON cms10_credit_purchases(member_id);
		ALTER TABLE cms10_credit_purchases ADD FOREIGN KEY `credit_purchases.member_id` (member_id) REFERENCES cms10_f_members (id);
