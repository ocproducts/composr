		...
		CREATE TABLE cms10_chat_messages
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE cms10_chat_blocking
		(
		...
		CREATE TABLE cms10_chat_friends
		(
		...
		CREATE TABLE cms10_chat_events
		(
			id integer auto_increment NULL,
		...
		CREATE TABLE cms10_chat_active
		(
			id integer auto_increment NULL,
			member_id integer NOT NULL,
			room_id integer NOT NULL,
		...
		CREATE TABLE cms10_chat_sound_effects
		(
		...
		CREATE INDEX `chat_rooms.c_welcome` ON cms10_chat_rooms(c_welcome);
		ALTER TABLE cms10_chat_rooms ADD FOREIGN KEY `chat_rooms.c_welcome` (c_welcome) REFERENCES cms10_translate (id);

		CREATE INDEX `chat_messages.room_id` ON cms10_chat_messages(room_id);
		ALTER TABLE cms10_chat_messages ADD FOREIGN KEY `chat_messages.room_id` (room_id) REFERENCES cms10_chat_rooms (id);

		CREATE INDEX `chat_messages.member_id` ON cms10_chat_messages(member_id);
		ALTER TABLE cms10_chat_messages ADD FOREIGN KEY `chat_messages.member_id` (member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_messages.the_message` ON cms10_chat_messages(the_message);
		ALTER TABLE cms10_chat_messages ADD FOREIGN KEY `chat_messages.the_message` (the_message) REFERENCES cms10_translate (id);

		CREATE INDEX `chat_blocking.member_blocker` ON cms10_chat_blocking(member_blocker);
		ALTER TABLE cms10_chat_blocking ADD FOREIGN KEY `chat_blocking.member_blocker` (member_blocker) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_blocking.member_blocked` ON cms10_chat_blocking(member_blocked);
		ALTER TABLE cms10_chat_blocking ADD FOREIGN KEY `chat_blocking.member_blocked` (member_blocked) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_friends.member_likes` ON cms10_chat_friends(member_likes);
		ALTER TABLE cms10_chat_friends ADD FOREIGN KEY `chat_friends.member_likes` (member_likes) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_friends.member_liked` ON cms10_chat_friends(member_liked);
		ALTER TABLE cms10_chat_friends ADD FOREIGN KEY `chat_friends.member_liked` (member_liked) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_events.e_member_id` ON cms10_chat_events(e_member_id);
		ALTER TABLE cms10_chat_events ADD FOREIGN KEY `chat_events.e_member_id` (e_member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_events.e_room_id` ON cms10_chat_events(e_room_id);
		ALTER TABLE cms10_chat_events ADD FOREIGN KEY `chat_events.e_room_id` (e_room_id) REFERENCES cms10_chat_rooms (id);

		CREATE INDEX `chat_active.member_id` ON cms10_chat_active(member_id);
		ALTER TABLE cms10_chat_active ADD FOREIGN KEY `chat_active.member_id` (member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `chat_active.room_id` ON cms10_chat_active(room_id);
		ALTER TABLE cms10_chat_active ADD FOREIGN KEY `chat_active.room_id` (room_id) REFERENCES cms10_chat_rooms (id);

		CREATE INDEX `chat_sound_effects.s_member` ON cms10_chat_sound_effects(s_member);
		ALTER TABLE cms10_chat_sound_effects ADD FOREIGN KEY `chat_sound_effects.s_member` (s_member) REFERENCES cms10_f_members (id);
