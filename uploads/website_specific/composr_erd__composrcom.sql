		...
		CREATE TABLE cms10_sites_email
		(
			s_codename varchar(80) NULL,
		...
		CREATE TABLE cms10_sites_deletion_codes
		(
			s_codename varchar(80) NULL,
		...
		CREATE TABLE cms10_sites_advert_pings
		(
			id integer auto_increment NULL,
		...
		CREATE INDEX `sites.s_member_id` ON cms10_sites(s_member_id);
		ALTER TABLE cms10_sites ADD FOREIGN KEY `sites.s_member_id` (s_member_id) REFERENCES cms10_f_members (id);
