		...
		CREATE INDEX `filedump.description` ON cms10_filedump(description);
		ALTER TABLE cms10_filedump ADD FOREIGN KEY `filedump.description` (description) REFERENCES cms10_translate (id);

		CREATE INDEX `filedump.the_member` ON cms10_filedump(the_member);
		ALTER TABLE cms10_filedump ADD FOREIGN KEY `filedump.the_member` (the_member) REFERENCES cms10_f_members (id);
