		CREATE TABLE cms10_classifieds_prices
		(
		...
		CREATE INDEX `classifieds_prices.c_label` ON cms10_classifieds_prices(c_label);
		ALTER TABLE cms10_classifieds_prices ADD FOREIGN KEY `classifieds_prices.c_label` (c_label) REFERENCES cms10_translate (id);
