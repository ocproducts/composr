		CREATE TABLE cms4_custom_comcode
		(
		...
		CREATE INDEX `custom_comcode.tag_description` ON cms4_custom_comcode(tag_description);
		ALTER TABLE cms4_custom_comcode ADD FOREIGN KEY `custom_comcode.tag_description` (tag_description) REFERENCES cms4_translate (id);

		CREATE INDEX `custom_comcode.tag_title` ON cms4_custom_comcode(tag_title);
		ALTER TABLE cms4_custom_comcode ADD FOREIGN KEY `custom_comcode.tag_title` (tag_title) REFERENCES cms4_translate (id);
