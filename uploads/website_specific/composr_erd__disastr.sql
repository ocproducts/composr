		...
		CREATE TABLE cms10_members_diseases
		(
		...
		CREATE INDEX `members_diseases.member_id` ON cms10_members_diseases(member_id);
		ALTER TABLE cms10_members_diseases ADD FOREIGN KEY `members_diseases.member_id` (member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `members_diseases.disease_id` ON cms10_members_diseases(disease_id);
		ALTER TABLE cms10_members_diseases ADD FOREIGN KEY `members_diseases.disease_id` (disease_id) REFERENCES cms10_diseases (id);
