		CREATE TABLE cms10_custom_comcode
		(
		...
		CREATE INDEX `custom_comcode.tag_description` ON cms10_custom_comcode(tag_description);
		ALTER TABLE cms10_custom_comcode ADD FOREIGN KEY `custom_comcode.tag_description` (tag_description) REFERENCES cms10_translate (id);

		CREATE INDEX `custom_comcode.tag_title` ON cms10_custom_comcode(tag_title);
		ALTER TABLE cms10_custom_comcode ADD FOREIGN KEY `custom_comcode.tag_title` (tag_title) REFERENCES cms10_translate (id);
