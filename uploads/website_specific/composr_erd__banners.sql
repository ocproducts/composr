		...
		CREATE TABLE cms10_banner_types
		(
		...
		CREATE TABLE cms10_banner_clicks
		(
		...
		CREATE INDEX `banners.b_type` ON cms10_banners(b_type);
		ALTER TABLE cms10_banners ADD FOREIGN KEY `banners.b_type` (b_type) REFERENCES cms10_banner_types (id);

		CREATE INDEX `banners.submitter` ON cms10_banners(submitter);
		ALTER TABLE cms10_banners ADD FOREIGN KEY `banners.submitter` (submitter) REFERENCES cms10_f_members (id);

		CREATE INDEX `banners.caption` ON cms10_banners(caption);
		ALTER TABLE cms10_banners ADD FOREIGN KEY `banners.caption` (caption) REFERENCES cms10_translate (id);

		CREATE INDEX `banner_clicks.c_member_id` ON cms10_banner_clicks(c_member_id);
		ALTER TABLE cms10_banner_clicks ADD FOREIGN KEY `banner_clicks.c_member_id` (c_member_id) REFERENCES cms10_f_members (id);
