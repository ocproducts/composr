		...
		CREATE TABLE cms10_members_gifts
		(
		...
		CREATE INDEX `members_gifts.gift_id` ON cms10_members_gifts(gift_id);
		ALTER TABLE cms10_members_gifts ADD FOREIGN KEY `members_gifts.gift_id` (gift_id) REFERENCES cms10_gifts (id);

		CREATE INDEX `members_gifts.from_member_id` ON cms10_members_gifts(from_member_id);
		ALTER TABLE cms10_members_gifts ADD FOREIGN KEY `members_gifts.from_member_id` (from_member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `members_gifts.to_member_id` ON cms10_members_gifts(to_member_id);
		ALTER TABLE cms10_members_gifts ADD FOREIGN KEY `members_gifts.to_member_id` (to_member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `gifts.gift_from` ON cms10_gifts(gift_from);
		ALTER TABLE cms10_gifts ADD FOREIGN KEY `gifts.gift_from` (gift_from) REFERENCES cms10_f_members (id);

		CREATE INDEX `gifts.gift_to` ON cms10_gifts(gift_to);
		ALTER TABLE cms10_gifts ADD FOREIGN KEY `gifts.gift_to` (gift_to) REFERENCES cms10_f_members (id);

		CREATE INDEX `gifts.reason` ON cms10_gifts(reason);
		ALTER TABLE cms10_gifts ADD FOREIGN KEY `gifts.reason` (reason) REFERENCES cms10_translate (id);
