		CREATE TABLE cms10_award_archive
		(
		...
		CREATE TABLE cms10_award_types
		(
		...
		CREATE INDEX `award_archive.a_type_id` ON cms10_award_archive(a_type_id);
		ALTER TABLE cms10_award_archive ADD FOREIGN KEY `award_archive.a_type_id` (a_type_id) REFERENCES cms10_award_types (id);

		CREATE INDEX `award_archive.member_id` ON cms10_award_archive(member_id);
		ALTER TABLE cms10_award_archive ADD FOREIGN KEY `award_archive.member_id` (member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `award_types.a_title` ON cms10_award_types(a_title);
		ALTER TABLE cms10_award_types ADD FOREIGN KEY `award_types.a_title` (a_title) REFERENCES cms10_translate (id);

		CREATE INDEX `award_types.a_description` ON cms10_award_types(a_description);
		ALTER TABLE cms10_award_types ADD FOREIGN KEY `award_types.a_description` (a_description) REFERENCES cms10_translate (id);
