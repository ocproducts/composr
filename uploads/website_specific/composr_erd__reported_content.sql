		CREATE TABLE cms10_reported_content
		(
		...
		CREATE INDEX `reported_content.r_session_id` ON cms10_reported_content(r_session_id);
		ALTER TABLE cms10_reported_content ADD FOREIGN KEY `reported_content.r_session_id` (r_session_id) REFERENCES cms10_sessions (id);
