		...
		CREATE INDEX `activities.a_member_id` ON cms10_activities(a_member_id);
		ALTER TABLE cms10_activities ADD FOREIGN KEY `activities.a_member_id` (a_member_id) REFERENCES cms10_f_members (id);

		CREATE INDEX `activities.a_also_involving` ON cms10_activities(a_also_involving);
		ALTER TABLE cms10_activities ADD FOREIGN KEY `activities.a_also_involving` (a_also_involving) REFERENCES cms10_f_members (id);
