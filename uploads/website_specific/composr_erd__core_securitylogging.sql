		...
		CREATE INDEX `hackattack.the_user` ON cms4_hackattack(the_user);
		ALTER TABLE cms4_hackattack ADD FOREIGN KEY `hackattack.the_user` (the_user) REFERENCES cms4_f_members (id);
