		CREATE TABLE cms10_match_key_messages
		(
		...
		CREATE INDEX `match_key_messages.k_message` ON cms10_match_key_messages(k_message);
		ALTER TABLE cms10_match_key_messages ADD FOREIGN KEY `match_key_messages.k_message` (k_message) REFERENCES cms10_translate (id);
