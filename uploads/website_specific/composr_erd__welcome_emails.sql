		CREATE TABLE cms10_f_welcome_emails
		(
			w_name varchar(255) NOT NULL,
			w_subject integer NOT NULL,
			w_text integer NOT NULL,
			w_send_time integer NOT NULL,
			w_newsletter integer NOT NULL,
			id integer auto_increment NULL,
			w_usergroup integer NOT NULL,
		...
		CREATE INDEX `f_welcome_emails.w_subject` ON cms10_f_welcome_emails(w_subject);
		ALTER TABLE cms10_f_welcome_emails ADD FOREIGN KEY `f_welcome_emails.w_subject` (w_subject) REFERENCES cms10_translate (id);

		CREATE INDEX `f_welcome_emails.w_text` ON cms10_f_welcome_emails(w_text);
		ALTER TABLE cms10_f_welcome_emails ADD FOREIGN KEY `f_welcome_emails.w_text` (w_text) REFERENCES cms10_translate (id);

		CREATE INDEX `f_welcome_emails.w_newsletter` ON cms10_f_welcome_emails(w_newsletter);
		ALTER TABLE cms10_f_welcome_emails ADD FOREIGN KEY `f_welcome_emails.w_newsletter` (w_newsletter) REFERENCES cms10_newsletters (id);

		CREATE INDEX `f_welcome_emails.w_usergroup` ON cms10_f_welcome_emails(w_usergroup);
		ALTER TABLE cms10_f_welcome_emails ADD FOREIGN KEY `f_welcome_emails.w_usergroup` (w_usergroup) REFERENCES cms10_f_groups (id);
