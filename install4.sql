...
INSERT INTO cms_privilege_list (p_section, the_name, the_default) VALUES ('FORUMS_AND_MEMBERS', 'exceed_post_edit_time_limit', 0);


INSERT INTO cms_privilege_list (p_section, the_name, the_default) VALUES ('FORUMS_AND_MEMBERS', 'exceed_post_delete_time_limit', 0);
...
INSERT INTO cms_privilege_list (p_section, the_name, the_default) VALUES ('SUBMISSION', 'set_own_author_profile', 1);
...
INSERT INTO cms_redirects (r_from_page, r_from_zone, r_to_page, r_to_zone, r_is_transparent) VALUES ('panel_top', 'adminzone', 'panel_top', '', 1);


INSERT INTO cms_redirects (r_from_page, r_from_zone, r_to_page, r_to_zone, r_is_transparent) VALUES ('panel_top', 'cms', 'panel_top', '', 1);
...
INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (1, 'Set up website configuration and structure', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (2, 'Make \'favicon\' theme image', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (3, 'Make \'webclipicon\' theme image', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (4, 'Make/install custom theme', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (5, 'Add your content', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (6, '[page=\"adminzone:admin_themes:edit_image:logo/standalone_logo:theme=default\"]Customise your mail/RSS logo[/page]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (7, '[page=\"adminzone:admin_themes:_edit_templates:theme=default:f0file=MAIL.tpl\"]Customise your \'MAIL\' template[/page]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (8, '[url=\"P3P Wizard (set up privacy policy)\"]http://www.p3pwiz.com/[/url]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (9, '[url=\"Submit to Google\"]https://www.google.com/webmasters/tools/submit-url?pli=1[/url]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (10, '[url=\"Submit to OpenDMOZ\"]http://www.dmoz.org/add.html[/url]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (11, '[url=\"Submit to Bing\"]http://www.bing.com/toolbox/submit-site-url[/url]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (12, '[html]<p style=\"margin: 0\">Facebook user? Like Composr on Facebook:</p><iframe src=\"http://compo.sr/uploads/website_specific/compo.sr/facebook.html\" scrolling=\"no\" frameborder=\"0\" style=\"border:none; overflow:hidden; width:430px; height:20px;\" allowTransparency=\"true\"></iframe>[/html]', 1454878282, 0, '', NULL);


INSERT INTO cms_staff_checklist_cus_tasks (id, task_title, add_date, recur_interval, recur_every, task_is_done) VALUES (13, '[url=\"Consider helping out with the Composr project\"]http://compo.sr/site/contributions.htm[/url]', 1454878282, 0, '', NULL);
...
INSERT INTO cms_task_queue (id, t_title, t_hook, t_args, t_member_id, t_secure_ref, t_send_notification, t_locked) VALUES (1, 'Install geolocation data', 'install_geolocation_data', 'a:0:{}', 1, '4785c2196d767', 0, 0);
...
INSERT INTO cms_values (the_name, the_value, date_and_time) VALUES ('version', '10.00', 1454878269);


INSERT INTO cms_values (the_name, the_value, date_and_time) VALUES ('cns_version', '10.00', 1454878269);


INSERT INTO cms_values (the_name, the_value, date_and_time) VALUES ('users_online', '0', 1454878275);


INSERT INTO cms_values (the_name, the_value, date_and_time) VALUES ('user_peak', '0', 1454878275);


INSERT INTO cms_values (the_name, the_value, date_and_time) VALUES ('user_peak_week', '0', 1454878275);
...
INSERT INTO cms_values_elective (the_name, the_value, date_and_time) VALUES ('call_home', '0', 1454878269);
...
INSERT INTO cms_wiki_pages (id, title, notes, description, add_date, edit_date, wiki_views, hide_posts, submitter, description__text_parsed, description__source_user) VALUES (1, 'Wiki+ home', '', '', 1454878281, NULL, 0, 0, 2, 'return unserialize(\"a:5:{i:0;a:1:{i:0;a:1:{i:0;a:5:{i:0;s:40:\\\"string_attach_56b7ae42651632.57339163_23\\\";i:1;a:0:{}i:2;i:1;i:3;s:0:\\\"\\\";i:4;s:0:\\\"\\\";}}}i:1;a:0:{}i:2;s:10:\\\":container\\\";i:3;N;i:4;a:1:{s:40:\\\"string_attach_56b7ae42651632.57339163_23\\\";s:69:\\\"\\$tpl_funcs[\'string_attach_56b7ae42651632.57339163_23\']=\\\"echo \\\\\\\"\\\\\\\";\\\";\\n\\\";}}\");\n', 1);
...
ALTER TABLE cms_f_topics ADD INDEX topic_order_4 (t_forum_id,t_cache_last_time);
